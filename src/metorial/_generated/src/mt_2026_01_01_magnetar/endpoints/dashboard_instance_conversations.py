...
class MetorialDashboardInstanceConversationsEndpoint(BaseMetorialEndpoint):
    """Assistant and conversation endpoints"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, assistant_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceConversationsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'conversations'],
            query=query_dict
        )
    ...
    def get(self, instance_id: str, assistant_conversation_id: str) -> DashboardInstanceConversationsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'conversations', assistant_conversation_id]
        )
        return self._get(request).transform(mapDashboardInstanceConversationsGetOutput.from_dict)

    def update(self, instance_id: str, assistant_conversation_id: str, *, title: Optional[str] = None) -> DashboardInstanceConversationsUpdateOutput:
        """
