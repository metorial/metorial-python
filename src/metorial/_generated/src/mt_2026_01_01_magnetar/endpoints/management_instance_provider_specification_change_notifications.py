...
class MetorialManagementInstanceProviderSpecificationChangeNotificationsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-specification-change-notifications'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-specification-change-notifications', notification_id]
        )
