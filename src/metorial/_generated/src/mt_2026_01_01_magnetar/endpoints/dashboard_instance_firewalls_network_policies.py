...
class MetorialDashboardInstanceFirewallsNetworkPoliciesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'firewalls', firewall_id, 'network-policies'],
            body=body_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'firewalls', firewall_id, 'network-policies', network_policy_id]
        )
