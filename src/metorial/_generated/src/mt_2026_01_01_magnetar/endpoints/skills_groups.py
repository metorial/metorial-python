...
class MetorialSkillsGroupsEndpoint(BaseMetorialEndpoint):
    """Skill groups organize skills into reusable collections."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, skill_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceSkillsGroupsListOutput:
        """
    List skill groups
    ...
    def get(self, skill_group_id: str) -> DashboardInstanceSkillsGroupsGetOutput:
        """
    Get skill group
    ...
    def delete(self, skill_group_id: str) -> DashboardInstanceSkillsGroupsDeleteOutput:
        """
    Delete skill group
