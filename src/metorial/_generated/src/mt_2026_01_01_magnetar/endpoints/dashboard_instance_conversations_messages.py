...
class MetorialDashboardInstanceConversationsMessagesEndpoint(BaseMetorialEndpoint):
    """Assistant and conversation endpoints"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, assistant_conversation_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceConversationsMessagesListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'conversations', assistant_conversation_id, 'messages'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceConversationsMessagesListOutput.from_dict)

    def create(self, instance_id: str, assistant_conversation_id: str, *, message: Dict[str, Any], parent_message_id: Optional[str] = None, model_id: Optional[str] = None) -> DashboardInstanceConversationsMessagesCreateOutput:
        """
    ...
    def get(self, instance_id: str, assistant_conversation_id: str, assistant_message_id: str) -> DashboardInstanceConversationsMessagesGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'conversations', assistant_conversation_id, 'messages', assistant_message_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'conversations', assistant_conversation_id, 'messages', assistant_message_id, 'handoff-responses'],
            body=body_dict
        )
