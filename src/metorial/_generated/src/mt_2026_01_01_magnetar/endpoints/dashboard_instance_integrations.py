...
class MetorialDashboardInstanceIntegrationsEndpoint(BaseMetorialEndpoint):
    """Integrations define reusable provider contracts that can then be materialized into integration instances."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, integration_provider_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsListOutput:
        """
    List integrations
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integrations'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceIntegrationsListOutput.from_dict)

    def get(self, instance_id: str, integration_id: str) -> DashboardInstanceIntegrationsGetOutput:
        """
    Get integration
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integrations', integration_id]
        )
    ...
    def delete(self, instance_id: str, integration_id: str) -> DashboardInstanceIntegrationsDeleteOutput:
        """
    Delete integration
