...
class MetorialDashboardInstanceSkillsTemplatesEndpoint(BaseMetorialEndpoint):
    """Skill templates define reusable starting points for skills."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, owner: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, integration_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceSkillsTemplatesListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skill-templates'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSkillsTemplatesListOutput.from_dict)

    def get(self, instance_id: str, skill_template_id: str) -> DashboardInstanceSkillsTemplatesGetOutput:
        """
    Get skill template
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skill-templates', skill_template_id]
        )
        return self._get(request).transform(mapDashboardInstanceSkillsTemplatesGetOutput.from_dict)

    def create(self, instance_id: str, *, name: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, from_skill_id: Optional[str] = None) -> DashboardInstanceSkillsTemplatesCreateOutput:
        """
    ...
    def update(self, instance_id: str, skill_template_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceSkillsTemplatesUpdateOutput:
        """
    ...
    def delete(self, instance_id: str, skill_template_id: str) -> DashboardInstanceSkillsTemplatesDeleteOutput:
        """
