...
class MetorialCallbacksEndpoint(BaseMetorialEndpoint):
    """Manage webhook-style callbacks backed by subspace trigger receivers."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, provider_deployment_id: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceCallbacksListOutput:
        """
    List callbacks
    ...
    def get(self, callback_id: str) -> DashboardInstanceCallbacksGetOutput:
        """
    Get callback
    ...
    def create(self, *, provider_deployment_id: str, name: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, poll_interval_seconds_override: Optional[float] = None, destination_ids: Optional[List[str]] = None, triggers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceCallbacksCreateOutput:
        """
    Create callback
    ...
    def update(self, callback_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, poll_interval_seconds_override: Optional[float] = None, destination_ids: Optional[List[str]] = None, triggers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceCallbacksUpdateOutput:
        """
    Update callback
    ...
    def delete(self, callback_id: str) -> DashboardInstanceCallbacksDeleteOutput:
        """
    Delete callback
