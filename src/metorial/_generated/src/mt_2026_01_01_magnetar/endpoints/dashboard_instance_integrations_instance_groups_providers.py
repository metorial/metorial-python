...
class MetorialDashboardInstanceIntegrationsInstanceGroupsProvidersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instance-group-providers'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instance-group-providers', integration_instance_group_provider_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instance-groups', integration_instance_group_id, 'providers', integration_instance_provider_id],
            body=body_dict
        )
