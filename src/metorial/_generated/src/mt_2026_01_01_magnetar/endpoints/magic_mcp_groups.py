...
class MetorialMagicMcpGroupsEndpoint(BaseMetorialEndpoint):
    """Magic MCP groups categorize servers and can be bound to token access."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, search: Optional[str] = None) -> DashboardInstanceMagicMcpGroupsListOutput:
        """
    ...
    def get(self, magic_mcp_group_id: str) -> DashboardInstanceMagicMcpGroupsGetOutput:
        """
    Get magic MCP group
    ...
    """
        request = MetorialRequest(
            path=['magic-mcp-groups', magic_mcp_group_id]
        )
        return self._get(request).transform(mapDashboardInstanceMagicMcpGroupsGetOutput.from_dict)

    def create(self, *, name: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceMagicMcpGroupsCreateOutput:
        """
    ...
    def delete(self, magic_mcp_group_id: str) -> DashboardInstanceMagicMcpGroupsDeleteOutput:
        """
    ...
    def update(self, magic_mcp_group_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceMagicMcpGroupsUpdateOutput:
        """
    ...
    def add_servers(self, magic_mcp_group_id: str, *, magic_mcp_server_ids: List[str]) -> DashboardInstanceMagicMcpGroupsAddServersOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['magic-mcp-groups', magic_mcp_group_id, 'add-servers'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceMagicMcpGroupsAddServersOutput.from_dict)

    def remove_servers(self, magic_mcp_group_id: str, *, magic_mcp_server_ids: List[str]) -> DashboardInstanceMagicMcpGroupsRemoveServersOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['magic-mcp-groups', magic_mcp_group_id, 'remove-servers'],
            body=body_dict
        )
