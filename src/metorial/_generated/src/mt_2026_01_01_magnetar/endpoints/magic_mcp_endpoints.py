...
class MetorialMagicMcpEndpointsEndpoint(BaseMetorialEndpoint):
    """Magic MCP endpoints combine multiple Magic MCP servers behind one routed connection target."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, magic_mcp_server_id: Optional[Union[str, List[str]]] = None, search: Optional[str] = None) -> DashboardInstanceMagicMcpEndpointsListOutput:
        """
    ...
    def get(self, magic_mcp_endpoint_id: str) -> DashboardInstanceMagicMcpEndpointsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['magic-mcp-endpoints', magic_mcp_endpoint_id]
        )
        return self._get(request).transform(mapDashboardInstanceMagicMcpEndpointsGetOutput.from_dict)

    def create(self, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, consumer_profile_id: Optional[str] = None, magic_mcp_server_ids: Optional[List[str]] = None, servers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceMagicMcpEndpointsCreateOutput:
        """
    ...
    def delete(self, magic_mcp_endpoint_id: str) -> DashboardInstanceMagicMcpEndpointsDeleteOutput:
        """
    ...
    def update(self, magic_mcp_endpoint_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceMagicMcpEndpointsUpdateOutput:
        """
    ...
    def add_servers(self, magic_mcp_endpoint_id: str, *, magic_mcp_server_ids: Optional[List[str]] = None, servers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceMagicMcpEndpointsAddServersOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['magic-mcp-endpoints', magic_mcp_endpoint_id, 'add-servers'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceMagicMcpEndpointsAddServersOutput.from_dict)

    def remove_servers(self, magic_mcp_endpoint_id: str, *, magic_mcp_server_ids: List[str]) -> DashboardInstanceMagicMcpEndpointsRemoveServersOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['magic-mcp-endpoints', magic_mcp_endpoint_id, 'remove-servers'],
            body=body_dict
        )
