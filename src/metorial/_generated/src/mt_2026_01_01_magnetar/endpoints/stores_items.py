...
class MetorialStoresItemsEndpoint(BaseMetorialEndpoint):
    """Create and manage instance stores backed by Cargo."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def modify(self, store_id: str, *, operations: List[Dict[str, Any]]) -> DashboardInstanceStoresItemsModifyOutput:
        """
    Modify store items
    ...
    def list(self, store_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, file_id: Optional[Union[str, List[str]]] = None, document_id: Optional[Union[str, List[str]]] = None, type: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceStoresItemsListOutput:
        """
    List store items
    ...
    def get(self, store_id: str, item_id: str) -> DashboardInstanceStoresItemsGetOutput:
        """
