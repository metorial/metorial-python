...
class MetorialSkillsExportsEndpoint(BaseMetorialEndpoint):
    """Export skills, skill plugins, and skill marketplaces as zip files."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, target: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSkillsExportsListOutput:
        """
    List skill exports
    ...
    def get(self, skill_export_id: str) -> DashboardInstanceSkillsExportsGetOutput:
        """
    Get skill export
    ...
    """
        request = MetorialRequest(
            path=['skill-exports', skill_export_id]
        )
        return self._get(request).transform(mapDashboardInstanceSkillsExportsGetOutput.from_dict)

    def create(self, *, target: str, skill_id: Optional[str] = None, skill_plugin_id: Optional[str] = None, skill_marketplace_id: Optional[str] = None) -> DashboardInstanceSkillsExportsCreateOutput:
        """
    Create skill export
