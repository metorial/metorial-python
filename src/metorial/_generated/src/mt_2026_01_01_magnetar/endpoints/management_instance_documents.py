...
class MetorialManagementInstanceDocumentsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'documents'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'documents', document_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'documents', document_id, 'clone'],
            body=body_dict
        )
