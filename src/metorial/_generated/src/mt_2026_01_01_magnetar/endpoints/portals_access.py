...
class MetorialPortalsAccessEndpoint(BaseMetorialEndpoint):
    ...
    def get(self, portal_id: str, access_id: str) -> DashboardInstancePortalsAccessGetOutput:
        """
    Get portal access
    ...
    """
        request = MetorialRequest(
            path=['portals', portal_id, 'access', access_id]
        )
        return self._get(request).transform(mapDashboardInstancePortalsAccessGetOutput.from_dict)

    def create(self, portal_id: str, *, consumer_group_id: str, access: Union[Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any]], name: Optional[str] = None, description: Optional[str] = None, readme: Optional[str] = None) -> DashboardInstancePortalsAccessCreateOutput:
        """
    ...
    def update(self, portal_id: str, access_id: str, *, name: Optional[str] = None, description: Optional[str] = None, readme: Optional[str] = None) -> DashboardInstancePortalsAccessUpdateOutput:
        """
    ...
    def delete(self, portal_id: str, access_id: str) -> DashboardInstancePortalsAccessDeleteOutput:
        """
