...
class MetorialProviderToolsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, provider_version_id: str, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceProviderToolsListOutput:
        """
    List provider tools
    ...
    def get(self, provider_tool_id: str) -> DashboardInstanceProviderToolsGetOutput:
        """
    Get provider tool
