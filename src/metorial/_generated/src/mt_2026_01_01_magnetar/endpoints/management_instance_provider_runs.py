...
class MetorialManagementInstanceProviderRunsEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-runs', provider_run_id]
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-runs', provider_run_id, 'logs']
        )
