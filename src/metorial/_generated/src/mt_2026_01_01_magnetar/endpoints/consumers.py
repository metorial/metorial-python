...
class MetorialConsumersEndpoint(BaseMetorialEndpoint):
    """Manage instance consumers independently from portals and inspect the profiles linked to each consumer."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, email: Optional[Union[str, List[str]]] = None, id: Optional[str] = None) -> DashboardInstanceConsumersListOutput:
        """
    List consumers
    ...
    def get(self, consumer_id: str) -> DashboardInstanceConsumersGetOutput:
        """
    Get consumer
    ...
    def create(self, *, name: str, email: str) -> DashboardInstanceConsumersCreateOutput:
        """
    Create consumer
    ...
    def update(self, consumer_id: str, *, name: Optional[str] = None, email: Optional[str] = None) -> DashboardInstanceConsumersUpdateOutput:
        """
    Update consumer
