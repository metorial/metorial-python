...
class MetorialDashboardInstanceSkillsAgentsEndpoint(BaseMetorialEndpoint):
    """Manage sub-agents attached to a skill."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def create(self, instance_id: str, skill_id: str, *, name: str, description: Optional[str] = None, content: Optional[str] = None) -> DashboardInstanceSkillsAgentsCreateOutput:
        """
    Create skill agent
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id, 'agents'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceSkillsAgentsCreateOutput.from_dict)

    def list(self, instance_id: str, skill_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, include_archived: Optional[bool] = None) -> DashboardInstanceSkillsAgentsListOutput:
        """
    List skill agents
    ...
    def get(self, instance_id: str, skill_id: str, skill_agent_id: str) -> DashboardInstanceSkillsAgentsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id, 'agents', skill_agent_id]
        )
        return self._get(request).transform(mapDashboardInstanceSkillsAgentsGetOutput.from_dict)

    def update(self, instance_id: str, skill_id: str, skill_agent_id: str, *, name: Optional[str] = None, description: Optional[str] = None) -> DashboardInstanceSkillsAgentsUpdateOutput:
        """
    Update skill agent
    ...
    def delete(self, instance_id: str, skill_id: str, skill_agent_id: str) -> DashboardInstanceSkillsAgentsDeleteOutput:
        """
    Delete skill agent
