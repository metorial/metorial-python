...
class MetorialMonitorsEndpoint(BaseMetorialEndpoint):
    """Monitors track automated observability checks for this instance."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, target: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, proto_guard_filter_id: Optional[Union[str, List[str]]] = None, search: Optional[str] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None, first_alert_at: Optional[Dict[str, Any]] = None, last_alert_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceMonitorsListOutput:
        """
    List monitors
    ...
    def get(self, monitor_id: str) -> DashboardInstanceMonitorsGetOutput:
        """
    Get monitor
