...
class MetorialDashboardInstanceProviderGroupsEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-groups', provider_group_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-groups', provider_group_id, 'listings'],
            body=body_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-groups', provider_group_id, 'listings', provider_listing_id]
        )
