...
class MetorialDashboardInstanceCustomProvidersEnvironmentsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-provider-environments'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-provider-environments', custom_provider_environment_id]
        )
