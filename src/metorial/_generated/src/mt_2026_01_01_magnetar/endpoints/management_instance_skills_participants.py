...
class MetorialManagementInstanceSkillsParticipantsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'participants'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'participants', skill_participant_id]
        )
