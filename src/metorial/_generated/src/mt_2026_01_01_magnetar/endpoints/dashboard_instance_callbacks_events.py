...
class MetorialDashboardInstanceCallbacksEventsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'callbacks', callback_id, 'events'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'callbacks', callback_id, 'events', callback_event_id]
        )
