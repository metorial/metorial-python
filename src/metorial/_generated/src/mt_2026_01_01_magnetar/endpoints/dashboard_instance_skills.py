...
class MetorialDashboardInstanceSkillsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSkillsListOutput.from_dict)

    def get(self, instance_id: str, skill_id: str) -> DashboardInstanceSkillsGetOutput:
        """
    Get skill
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id]
        )
    ...
    def delete(self, instance_id: str, skill_id: str) -> DashboardInstanceSkillsDeleteOutput:
        """
    Delete skill
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id, 'fork'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceSkillsForkOutput.from_dict)

    def publish_consumer_skill(self, instance_id: str, skill_id: str) -> DashboardInstanceSkillsPublishConsumerSkillOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id, 'duplicate'],
            body=body_dict
        )
