...
class MetorialDashboardInstanceSkillsItemsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id, 'items'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skills', skill_id, 'items', skill_item_id]
        )
