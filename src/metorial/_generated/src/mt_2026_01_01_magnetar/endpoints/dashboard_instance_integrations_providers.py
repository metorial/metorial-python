...
class MetorialDashboardInstanceIntegrationsProvidersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-providers'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceIntegrationsProvidersListOutput.from_dict)

    def get(self, instance_id: str, integration_provider_id: str) -> DashboardInstanceIntegrationsProvidersGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-providers', integration_provider_id]
        )
    ...
    def delete(self, instance_id: str, integration_provider_id: str) -> DashboardInstanceIntegrationsProvidersDeleteOutput:
        """
