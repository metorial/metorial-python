...
class MetorialDashboardInstanceProtoGuardAlertsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'protoguard-alerts'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProtoGuardAlertsListOutput.from_dict)

    def get(self, instance_id: str, proto_guard_alert_id: str) -> DashboardInstanceProtoGuardAlertsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'protoguard-alerts', proto_guard_alert_id]
        )
