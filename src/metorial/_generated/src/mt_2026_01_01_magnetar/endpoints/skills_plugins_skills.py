...
class MetorialSkillsPluginsSkillsEndpoint(BaseMetorialEndpoint):
    ...
    def get(self, skill_plugin_id: str, skill_plugin_skill_id: str) -> DashboardInstanceSkillsPluginsSkillsGetOutput:
        """
    ...
    def remove(self, skill_plugin_id: str, skill_plugin_skill_id: str) -> DashboardInstanceSkillsPluginsSkillsRemoveOutput:
        """
