...
class MetorialDashboardInstanceSkillsMarketplacesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skill-marketplaces'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skill-marketplaces', skill_marketplace_id]
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'skill-marketplaces', skill_marketplace_id, 'sync']
        )
