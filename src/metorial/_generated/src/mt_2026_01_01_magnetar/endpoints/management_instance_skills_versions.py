...
class MetorialManagementInstanceSkillsVersionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'versions'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'versions', skill_version_id]
        )
