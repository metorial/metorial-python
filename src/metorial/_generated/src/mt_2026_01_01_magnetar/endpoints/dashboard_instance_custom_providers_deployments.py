...
class MetorialDashboardInstanceCustomProvidersDeploymentsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, custom_provider_version_id: Optional[Union[str, List[str]]] = None, custom_provider_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceCustomProvidersDeploymentsListOutput:
        """
