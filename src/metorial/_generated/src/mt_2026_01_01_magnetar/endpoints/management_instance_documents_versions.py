...
class MetorialManagementInstanceDocumentsVersionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'documents', document_id, 'versions'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'documents', document_id, 'versions', document_version_id]
        )
