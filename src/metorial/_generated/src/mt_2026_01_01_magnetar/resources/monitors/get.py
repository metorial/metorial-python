...
class mapMonitorsGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> MonitorsGetOutput:
        return MonitorsGetOutput(
    ...
    @staticmethod
    def to_dict(value: Union[MonitorsGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
