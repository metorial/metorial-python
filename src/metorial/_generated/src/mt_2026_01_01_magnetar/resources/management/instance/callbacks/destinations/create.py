...
class mapManagementInstanceCallbacksDestinationsCreateOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementInstanceCallbacksDestinationsCreateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementInstanceCallbacksDestinationsCreateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementInstanceCallbacksDestinationsCreateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementInstanceCallbacksDestinationsCreateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
