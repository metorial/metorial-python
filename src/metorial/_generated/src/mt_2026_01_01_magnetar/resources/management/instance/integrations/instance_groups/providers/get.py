...
@dataclass
class ManagementInstanceIntegrationsInstanceGroupsProvidersGetOutput:
    object: str
    id: str
    status: str
    name: str
...
class mapManagementInstanceIntegrationsInstanceGroupsProvidersGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementInstanceIntegrationsInstanceGroupsProvidersGetOutput:
        return ManagementInstanceIntegrationsInstanceGroupsProvidersGetOutput(
    ...
    @staticmethod
    def to_dict(value: Union[ManagementInstanceIntegrationsInstanceGroupsProvidersGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
