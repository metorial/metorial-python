...
@dataclass
class ManagementInstancePortalsGetOutputSkillConfiguration:
    object: str
    id: str
    is_default: bool
    allow_scripts: bool
...
class ManagementInstancePortalsGetOutput:
    ...
    skill_configuration: ManagementInstancePortalsGetOutputSkillConfiguration
...
class mapManagementInstancePortalsGetOutputSkillConfiguration:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementInstancePortalsGetOutputSkillConfiguration:
        return ManagementInstancePortalsGetOutputSkillConfiguration(
    ...
    @staticmethod
    def to_dict(value: Union[ManagementInstancePortalsGetOutputSkillConfiguration, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementInstancePortalsGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementInstancePortalsGetOutput:
        ...
        skill_configuration=mapManagementInstancePortalsGetOutputSkillConfiguration.from_dict(data.get('skill_configuration')) if data.get('skill_configuration') else None,
