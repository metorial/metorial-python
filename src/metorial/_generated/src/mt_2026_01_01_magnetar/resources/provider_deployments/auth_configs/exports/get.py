...
@dataclass
class ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview:
    object: str
    id: str
    is_default: bool
    provider_id: str
...
class ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfig:
    ...
    description: Optional[str] = None
    metadata: Optional[Dict[str, Any]] = None
    deployment_preview: Optional[ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview] = None
...
class mapProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview:
        return ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview(
    ...
    @staticmethod
    def to_dict(value: Union[ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapProviderDeploymentsAuthConfigsExportsGetOutputAuthConfig:
    ...
    def from_dict(data: Dict[str, Any]) -> ProviderDeploymentsAuthConfigsExportsGetOutputAuthConfig:
        ...
        description=data.get('description'),
        metadata=data.get('metadata'),
        deployment_preview=mapProviderDeploymentsAuthConfigsExportsGetOutputAuthConfigDeploymentPreview.from_dict(data.get('deployment_preview')) if data.get('deployment_preview') else None,
