...
@dataclass
class ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment:
    object: str
    id: str
    is_default: bool
    provider_id: str
...
class ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfig:
    ...
    description: Optional[str] = None
    metadata: Optional[Dict[str, Any]] = None
    deployment: Optional[ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment] = None
...
class mapProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment:
        return ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment(
    ...
    @staticmethod
    def to_dict(value: Union[ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapProviderDeploymentsAuthConfigsImportsGetOutputAuthConfig:
    ...
    def from_dict(data: Dict[str, Any]) -> ProviderDeploymentsAuthConfigsImportsGetOutputAuthConfig:
        ...
        deployment=mapProviderDeploymentsAuthConfigsImportsGetOutputAuthConfigDeployment.from_dict(data.get('deployment')) if data.get('deployment') else None,
