...
class mapFilesGetOutputPurpose:
    ...
    @staticmethod
    def to_dict(value: Union[FilesGetOutputPurpose, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapFilesGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> FilesGetOutput:
        ...
        purpose=mapFilesGetOutputPurpose.from_dict(data.get('purpose')) if data.get('purpose') else None,
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None
        )

    @staticmethod
    def to_dict(value: Union[FilesGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
