...
@dataclass
class StoresPermissionsGetOutput:
    object: str
    store_id: str
...
class mapStoresPermissionsGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> StoresPermissionsGetOutput:
        return StoresPermissionsGetOutput(
    ...
    @staticmethod
    def to_dict(value: Union[StoresPermissionsGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
