...
class mapCallbacksUpdateOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> CallbacksUpdateOutput:
        return CallbacksUpdateOutput(
        object=data.get('object'),
        id=data.get('id'),
        status=data.get('status'),
        name=data.get('name'),
    ...
    @staticmethod
    def to_dict(value: Union[CallbacksUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapCallbacksUpdateBody:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> CallbacksUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[CallbacksUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
