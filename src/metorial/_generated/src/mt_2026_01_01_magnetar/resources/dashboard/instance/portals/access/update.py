...
class DashboardInstancePortalsAccessUpdateOutputConsumerGroup:
    ...
    description: Optional[str] = None
@dataclass
class DashboardInstancePortalsAccessUpdateOutput:
    object: str
    id: str
    name: str
    access: Dict[str, Any]
    consumer_group: DashboardInstancePortalsAccessUpdateOutputConsumerGroup
    created_at: datetime
    updated_at: datetime
    description: Optional[str] = None
...
class mapDashboardInstancePortalsAccessUpdateOutputConsumerGroup:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsAccessUpdateOutputConsumerGroup:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstancePortalsAccessUpdateOutputConsumerGroup, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardInstancePortalsAccessUpdateOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsAccessUpdateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstancePortalsAccessUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
@dataclass
class DashboardInstancePortalsAccessUpdateBody:
    name: Optional[str] = None
    description: Optional[str] = None
    readme: Optional[str] = None


class mapDashboardInstancePortalsAccessUpdateBody:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsAccessUpdateBody:
        return DashboardInstancePortalsAccessUpdateBody(
        name=data.get('name'),
        description=data.get('description'),
        readme=data.get('readme')
        )
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstancePortalsAccessUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
