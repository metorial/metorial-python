...
class mapDashboardInstanceLinksUpdateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceLinksUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardInstanceLinksUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceLinksUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
