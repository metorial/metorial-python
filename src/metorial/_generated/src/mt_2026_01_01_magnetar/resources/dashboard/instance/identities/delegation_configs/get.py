...
@dataclass
class DashboardInstanceIdentitiesDelegationConfigsGetOutput:
    object: str
    id: str
    status: str
    is_default: bool
...
class mapDashboardInstanceIdentitiesDelegationConfigsGetOutput:
    @staticmethod
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceIdentitiesDelegationConfigsGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
