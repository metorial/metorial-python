...
@dataclass
class DashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput:
    object: str
    id: str
    status: str
    name: str
...
class mapDashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
