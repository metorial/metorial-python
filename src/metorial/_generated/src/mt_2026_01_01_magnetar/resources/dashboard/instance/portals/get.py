...
@dataclass
class DashboardInstancePortalsGetOutputSkillConfiguration:
    object: str
    id: str
    is_default: bool
    allow_scripts: bool
...
@dataclass
class DashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters:
    url: str
@dataclass
class DashboardInstancePortalsGetOutputAuth:
    object: str
    session_expiry_time_in_seconds: float
    allowed_redirect_url_filters: List[DashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters]
@dataclass
...
class DashboardInstancePortalsGetOutput:
    ...
    skill_configuration: DashboardInstancePortalsGetOutputSkillConfiguration
...
class mapDashboardInstancePortalsGetOutputSkillConfiguration:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsGetOutputSkillConfiguration:
        return DashboardInstancePortalsGetOutputSkillConfiguration(
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstancePortalsGetOutputSkillConfiguration, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters:
        return DashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters(
        url=data.get('url')
        )

    @staticmethod
    def to_dict(value: Union[DashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardInstancePortalsGetOutputAuth:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsGetOutputAuth:
        ...
        allowed_redirect_url_filters=[mapDashboardInstancePortalsGetOutputAuthAllowedRedirectUrlFilters.from_dict(item) for item in data.get('allowed_redirect_url_filters', []) if item]
        )
...
class mapDashboardInstancePortalsGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstancePortalsGetOutput:
        ...
        skill_configuration=mapDashboardInstancePortalsGetOutputSkillConfiguration.from_dict(data.get('skill_configuration')) if data.get('skill_configuration') else None,
