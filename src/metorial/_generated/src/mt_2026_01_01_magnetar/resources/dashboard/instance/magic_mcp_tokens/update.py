...
@dataclass
class DashboardInstanceMagicMcpTokensUpdateOutputEndpoint:
    object: str
    id: str
    status: str
    slug: str
...
class DashboardInstanceMagicMcpTokensUpdateOutput:
    ...
    endpoint: Optional[DashboardInstanceMagicMcpTokensUpdateOutputEndpoint] = None
...
class mapDashboardInstanceMagicMcpTokensUpdateOutputEndpoint:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceMagicMcpTokensUpdateOutputEndpoint:
        return DashboardInstanceMagicMcpTokensUpdateOutputEndpoint(
        object=data.get('object'),
        id=data.get('id'),
        status=data.get('status'),
        slug=data.get('slug'),
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceMagicMcpTokensUpdateOutputEndpoint, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardInstanceMagicMcpTokensUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceMagicMcpTokensUpdateOutput:
        ...
        endpoint=mapDashboardInstanceMagicMcpTokensUpdateOutputEndpoint.from_dict(data.get('endpoint')) if data.get('endpoint') else None,
