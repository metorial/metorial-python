...
class mapDashboardInstanceFilesLinksDeleteOutput:
    @staticmethod
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceFilesLinksDeleteOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
