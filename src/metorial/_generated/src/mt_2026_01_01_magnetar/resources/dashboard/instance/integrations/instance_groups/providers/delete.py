...
@dataclass
class DashboardInstanceIntegrationsInstanceGroupsProvidersDeleteOutput:
    object: str
    id: str
    status: str
    name: str
...
class mapDashboardInstanceIntegrationsInstanceGroupsProvidersDeleteOutput:
    @staticmethod
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceIntegrationsInstanceGroupsProvidersDeleteOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
