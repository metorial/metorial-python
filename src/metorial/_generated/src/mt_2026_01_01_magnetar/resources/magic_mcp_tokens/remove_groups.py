...
@dataclass
class MagicMcpTokensRemoveGroupsOutputServer:
    object: str
    id: str
    status: str
...
@dataclass
class MagicMcpTokensRemoveGroupsOutputEndpoint:
    object: str
    id: str
    status: str
    slug: str
...
class MagicMcpTokensRemoveGroupsOutput:
    ...
    name: Optional[str] = None
    description: Optional[str] = None
    server: Optional[MagicMcpTokensRemoveGroupsOutputServer] = None
    endpoint: Optional[MagicMcpTokensRemoveGroupsOutputEndpoint] = None


class mapMagicMcpTokensRemoveGroupsOutputServer:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> MagicMcpTokensRemoveGroupsOutputServer:
        return MagicMcpTokensRemoveGroupsOutputServer(
    ...
    @staticmethod
    def to_dict(value: Union[MagicMcpTokensRemoveGroupsOutputServer, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapMagicMcpTokensRemoveGroupsOutputEndpoint:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> MagicMcpTokensRemoveGroupsOutputEndpoint:
        return MagicMcpTokensRemoveGroupsOutputEndpoint(
        object=data.get('object'),
        id=data.get('id'),
        status=data.get('status'),
        slug=data.get('slug'),
    ...
    @staticmethod
    def to_dict(value: Union[MagicMcpTokensRemoveGroupsOutputEndpoint, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapMagicMcpTokensRemoveGroupsOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> MagicMcpTokensRemoveGroupsOutput:
        ...
        name=data.get('name'),
        description=data.get('description'),
        server=mapMagicMcpTokensRemoveGroupsOutputServer.from_dict(data.get('server')) if data.get('server') else None,
        endpoint=mapMagicMcpTokensRemoveGroupsOutputEndpoint.from_dict(data.get('endpoint')) if data.get('endpoint') else None,
