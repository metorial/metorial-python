...
@dataclass
class MagicMcpTokensAddGroupsOutputEndpoint:
    object: str
    id: str
    status: str
    slug: str
...
class MagicMcpTokensAddGroupsOutput:
    ...
    endpoint: Optional[MagicMcpTokensAddGroupsOutputEndpoint] = None
...
class mapMagicMcpTokensAddGroupsOutputEndpoint:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> MagicMcpTokensAddGroupsOutputEndpoint:
        return MagicMcpTokensAddGroupsOutputEndpoint(
        object=data.get('object'),
        id=data.get('id'),
        status=data.get('status'),
        slug=data.get('slug'),
    ...
    @staticmethod
    def to_dict(value: Union[MagicMcpTokensAddGroupsOutputEndpoint, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapMagicMcpTokensAddGroupsOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> MagicMcpTokensAddGroupsOutput:
        ...
        endpoint=mapMagicMcpTokensAddGroupsOutputEndpoint.from_dict(data.get('endpoint')) if data.get('endpoint') else None,
