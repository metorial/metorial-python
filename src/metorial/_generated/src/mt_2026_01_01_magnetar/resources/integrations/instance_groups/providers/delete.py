...
@dataclass
class IntegrationsInstanceGroupsProvidersDeleteOutput:
    object: str
    id: str
    status: str
    name: str
...
class mapIntegrationsInstanceGroupsProvidersDeleteOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> IntegrationsInstanceGroupsProvidersDeleteOutput:
        return IntegrationsInstanceGroupsProvidersDeleteOutput(
    ...
    @staticmethod
    def to_dict(value: Union[IntegrationsInstanceGroupsProvidersDeleteOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
