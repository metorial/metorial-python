...
@dataclass
class PortalsAccessUpdateOutputListing:
    id: str
    name: str
...
class PortalsAccessUpdateOutput:
    ...
    listing: Optional[PortalsAccessUpdateOutputListing] = None


class mapPortalsAccessUpdateOutputListing:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> PortalsAccessUpdateOutputListing:
        return PortalsAccessUpdateOutputListing(
        id=data.get('id'),
        name=data.get('name'),
    ...
    @staticmethod
    def to_dict(value: Union[PortalsAccessUpdateOutputListing, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapPortalsAccessUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> PortalsAccessUpdateOutput:
        ...
        listing=mapPortalsAccessUpdateOutputListing.from_dict(data.get('listing')) if data.get('listing') else None,
