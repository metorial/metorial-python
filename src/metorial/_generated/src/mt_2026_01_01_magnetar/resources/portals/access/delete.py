...
@dataclass
class PortalsAccessDeleteOutput:
    object: str
    id: str
    name: str
    access: Dict[str, Any]
...
class mapPortalsAccessDeleteOutputConsumerGroup:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> PortalsAccessDeleteOutputConsumerGroup:
    ...
    @staticmethod
    def to_dict(value: Union[PortalsAccessDeleteOutputConsumerGroup, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapPortalsAccessDeleteOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> PortalsAccessDeleteOutput:
    ...
    @staticmethod
    def to_dict(value: Union[PortalsAccessDeleteOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
