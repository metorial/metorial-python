...
class MetorialSessionsErrorsEndpoint(BaseMetorialEndpoint):
    ...
    def get(self, session_error_id: str) -> DashboardInstanceSessionsErrorsGetOutput:
        """
    Get session error
    ...
    """
        request = MetorialRequest(
            path=['session-errors', session_error_id]
        )
