...
class MetorialManagementInstancePortalsConsumerProfilesEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'consumer-profile', consumer_profile_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'consumer-profile', consumer_profile_id, 'assign-groups'],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'consumer-profile', consumer_profile_id, 'unassign-groups'],
            body=body_dict
        )
