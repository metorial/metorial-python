...
class MetorialManagementInstanceScmConnectionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'scm', 'connections'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'scm', 'connections', scm_connection_id]
        )
