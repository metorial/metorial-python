...
class MetorialDashboardInstancePortalsConsumerGroupsEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'portals', portal_id, 'consumer-groups', consumer_group_id]
        )
