...
class MetorialDashboardOrganizationsInstancesEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsInstancesListOutput:
        """
    ...
    """
        ...
        return self._get(request).transform(mapDashboardOrganizationsInstancesListOutput.from_dict)

    def get(self, organization_id: str, instance_id: str) -> DashboardOrganizationsInstancesGetOutput:
        """
    ...
    """
        ...
        return self._get(request).transform(mapDashboardOrganizationsInstancesGetOutput.from_dict)

    def create(self, organization_id: str, *, name: str, type: str, project_id: str) -> DashboardOrganizationsInstancesCreateOutput:
        """
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsInstancesCreateOutput.from_dict)

    def delete(self, organization_id: str, instance_id: str) -> DashboardOrganizationsInstancesDeleteOutput:
        """
    ...
    """
        ...
        return self._delete(request).transform(mapDashboardOrganizationsInstancesDeleteOutput.from_dict)

    def update(self, organization_id: str, instance_id: str, *, name: Optional[str] = None) -> DashboardOrganizationsInstancesUpdateOutput:
        """
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsInstancesUpdateOutput.from_dict)
