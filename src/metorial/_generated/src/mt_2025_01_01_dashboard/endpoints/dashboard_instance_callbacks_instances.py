...
class MetorialDashboardInstanceCallbacksInstancesEndpoint(BaseMetorialEndpoint):
    """Attach or detach callback instances for a deployment/config/auth-config combination."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, callback_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, provider_config_id: Optional[Union[str, List[str]]] = None, provider_auth_config_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceCallbacksInstancesListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'callbacks', callback_id, 'instances'],
            query=query_dict
        )
    ...
    def delete(self, instance_id: str, callback_id: str, callback_instance_id: str) -> DashboardInstanceCallbacksInstancesDeleteOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'callbacks', callback_id, 'instances', callback_instance_id]
        )
