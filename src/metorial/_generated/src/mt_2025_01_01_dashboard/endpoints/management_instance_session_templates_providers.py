...
class MetorialManagementInstanceSessionTemplatesProvidersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'session-template-providers'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSessionTemplatesProvidersListOutput.from_dict)

    def get(self, instance_id: str, session_template_provider_id: str) -> DashboardInstanceSessionTemplatesProvidersGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'session-template-providers', session_template_provider_id]
        )
    ...
    def delete(self, instance_id: str, session_template_provider_id: str) -> DashboardInstanceSessionTemplatesProvidersDeleteOutput:
        """
