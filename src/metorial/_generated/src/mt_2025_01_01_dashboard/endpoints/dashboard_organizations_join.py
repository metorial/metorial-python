...
class MetorialDashboardOrganizationsJoinEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        query_dict = {}
        query_dict["invite_key"] = invite_key

        request = MetorialRequest(
            path=['dashboard', 'organization-join', 'find'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsJoinGetOutput.from_dict)
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsJoinAcceptOutput.from_dict)
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsJoinRejectOutput.from_dict)
