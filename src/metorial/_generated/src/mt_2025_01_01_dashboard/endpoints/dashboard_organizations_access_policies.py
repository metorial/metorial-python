...
class MetorialDashboardOrganizationsAccessPoliciesEndpoint(BaseMetorialEndpoint):
    """Manage organization access policies"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsAccessPoliciesListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'access-policies'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsAccessPoliciesListOutput.from_dict)

    def get(self, organization_id: str, access_policy_id: str) -> DashboardOrganizationsAccessPoliciesGetOutput:
        """
    Get access policy
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'access-policies', access_policy_id]
        )
        return self._get(request).transform(mapDashboardOrganizationsAccessPoliciesGetOutput.from_dict)

    def versions(self, organization_id: str, access_policy_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsAccessPoliciesVersionsOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'access-policies', access_policy_id, 'versions'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsAccessPoliciesVersionsOutput.from_dict)

    def create(self, organization_id: str, *, name: str, document: Dict[str, Any], description: Optional[str] = None, message: Optional[str] = None) -> DashboardOrganizationsAccessPoliciesCreateOutput:
        """
    ...
    def update(self, organization_id: str, access_policy_id: str, *, name: Optional[str] = None, description: Optional[str] = None, document: Optional[Dict[str, Any]] = None, message: Optional[str] = None) -> DashboardOrganizationsAccessPoliciesUpdateOutput:
        """
    ...
    def delete(self, organization_id: str, access_policy_id: str) -> DashboardOrganizationsAccessPoliciesDeleteOutput:
        """
