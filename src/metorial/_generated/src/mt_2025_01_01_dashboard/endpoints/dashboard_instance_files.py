...
class MetorialDashboardInstanceFilesEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, purpose: Optional[str] = None, organization_id: Optional[str] = None) -> DashboardInstanceFilesListOutput:
        """
    List instance files
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'files'],
            query=query_dict
        )
    ...
    def update(self, instance_id: str, file_id: str, *, title: Optional[str] = None) -> DashboardInstanceFilesUpdateOutput:
        """
    Update file by ID
