...
class MetorialManagementInstancePortalsAccessRequestsEndpoint(BaseMetorialEndpoint):
    ...
    def get(self, instance_id: str, portal_id: str, consumer_access_request_id: str) -> DashboardInstancePortalsAccessRequestsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'access-requests', consumer_access_request_id]
        )
        return self._get(request).transform(mapDashboardInstancePortalsAccessRequestsGetOutput.from_dict)

    def update(self, instance_id: str, portal_id: str, consumer_access_request_id: str, *, status: str, resolution_message: Optional[str] = None, consumer_group_id: Optional[str] = None) -> DashboardInstancePortalsAccessRequestsUpdateOutput:
        """
