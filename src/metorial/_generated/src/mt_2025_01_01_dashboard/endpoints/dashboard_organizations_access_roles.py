...
class MetorialDashboardOrganizationsAccessRolesEndpoint(BaseMetorialEndpoint):
    """Manage organization access roles"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsAccessRolesListOutput:
        """
    List access roles
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'access-roles'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsAccessRolesListOutput.from_dict)

    def get(self, organization_id: str, access_role_id: str) -> DashboardOrganizationsAccessRolesGetOutput:
        """
    Get access role
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'access-roles', access_role_id]
        )
        return self._get(request).transform(mapDashboardOrganizationsAccessRolesGetOutput.from_dict)

    def versions(self, organization_id: str, access_role_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsAccessRolesVersionsOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'access-roles', access_role_id, 'versions'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsAccessRolesVersionsOutput.from_dict)

    def create(self, organization_id: str, *, name: str, description: Optional[str] = None, scopes: Optional[List[str]] = None, message: Optional[str] = None) -> DashboardOrganizationsAccessRolesCreateOutput:
        """
    Create access role
    ...
    def update(self, organization_id: str, access_role_id: str, *, name: Optional[str] = None, description: Optional[str] = None, scopes: Optional[List[str]] = None, message: Optional[str] = None) -> DashboardOrganizationsAccessRolesUpdateOutput:
        """
    Update access role
    ...
    def delete(self, organization_id: str, access_role_id: str) -> DashboardOrganizationsAccessRolesDeleteOutput:
        """
    Delete access role
