...
class MetorialManagementInstanceProviderDeploymentsAuthConfigsImportsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-auth-config-imports'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-auth-config-imports', provider_auth_import_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-auth-config-imports', 'schema'],
            query=query_dict
        )
