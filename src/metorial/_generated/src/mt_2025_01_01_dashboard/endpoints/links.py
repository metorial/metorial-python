...
class MetorialLinksEndpoint(BaseMetorialEndpoint):
    ...
    def create(self, file_id: str, *, expires_at: Optional[datetime] = None) -> DashboardInstanceLinksCreateOutput:
        """
    Create file link
    ...
    def update(self, file_id: str, link_id: str, *, expires_at: Optional[datetime] = None) -> DashboardInstanceLinksUpdateOutput:
        """
