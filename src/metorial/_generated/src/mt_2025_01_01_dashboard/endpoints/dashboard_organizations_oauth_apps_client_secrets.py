...
class MetorialDashboardOrganizationsOauthAppsClientSecretsEndpoint(BaseMetorialEndpoint):
    """Create and manage OAuth applications for an organization"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def create(self, organization_id: str, oauth_application_id: str) -> DashboardOrganizationsOauthAppsClientSecretsCreateOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'oauth', 'apps', oauth_application_id, 'client-secrets']
        )
        return self._post(request).transform(mapDashboardOrganizationsOauthAppsClientSecretsCreateOutput.from_dict)

    def delete(self, organization_id: str, oauth_application_id: str, oauth_application_client_secret_id: str) -> DashboardOrganizationsOauthAppsClientSecretsDeleteOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'oauth', 'apps', oauth_application_id, 'client-secrets', oauth_application_client_secret_id]
        )
