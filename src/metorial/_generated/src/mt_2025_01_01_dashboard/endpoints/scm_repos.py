...
class MetorialScmReposEndpoint(BaseMetorialEndpoint):
    """Manage source control repositories."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceScmReposListOutput:
        """
    List SCM repos
    ...
    def get(self, scm_repository_id: str) -> DashboardInstanceScmReposGetOutput:
        """
    Get SCM repo
    ...
    """
        request = MetorialRequest(
            path=['scm', 'repos', scm_repository_id]
        )
        return self._get(request).transform(mapDashboardInstanceScmReposGetOutput.from_dict)

    def preview(self, *, installation_id: str, external_account_id: Optional[str] = None) -> DashboardInstanceScmReposPreviewOutput:
        """
    Preview SCM repos
    ...
    """
        ...
        request = MetorialRequest(
            path=['scm', 'repos', 'preview'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceScmReposPreviewOutput.from_dict)

    def create(self, *, installation_id: str, external_repo_id: str = None, external_account_id: str = None, name: str = None, is_private: Optional[bool] = None) -> DashboardInstanceScmReposCreateOutput:
        """
    Create SCM repo
