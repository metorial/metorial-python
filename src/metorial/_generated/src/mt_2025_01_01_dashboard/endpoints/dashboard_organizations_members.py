...
class MetorialDashboardOrganizationsMembersEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, team_id: Optional[Union[str, List[str]]] = None) -> DashboardOrganizationsMembersListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'members'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsMembersListOutput.from_dict)

    def get(self, organization_id: str, member_id: str) -> DashboardOrganizationsMembersGetOutput:
        """
    ...
    def delete(self, organization_id: str, member_id: str) -> DashboardOrganizationsMembersDeleteOutput:
        """
    ...
    def update(self, organization_id: str, member_id: str, *, role: str) -> DashboardOrganizationsMembersUpdateOutput:
        """
