...
class MetorialManagementInstanceConsumersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'consumers'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'consumers', consumer_id]
        )
