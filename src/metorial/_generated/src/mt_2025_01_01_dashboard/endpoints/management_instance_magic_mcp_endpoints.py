...
class MetorialManagementInstanceMagicMcpEndpointsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-endpoints'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-endpoints', magic_mcp_endpoint_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-endpoints', magic_mcp_endpoint_id, 'add-servers'],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-endpoints', magic_mcp_endpoint_id, 'remove-servers'],
            body=body_dict
        )
