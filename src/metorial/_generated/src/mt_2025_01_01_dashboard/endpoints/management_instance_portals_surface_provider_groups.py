...
class MetorialManagementInstancePortalsSurfaceProviderGroupsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'surface-provider-groups'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'surface-provider-groups', consumer_surface_provider_group_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'surface-provider-groups', consumer_surface_provider_group_id, 'listings'],
            body=body_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'surface-provider-groups', consumer_surface_provider_group_id, 'listings', consumer_access_listing_id]
        )
