...
class MetorialManagementOrganizationProjectsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, team_id: Optional[Union[str, List[str]]] = None) -> DashboardOrganizationsProjectsListOutput:
        """
    ...
    def update(self, project_id: str, *, name: Optional[str] = None) -> DashboardOrganizationsProjectsUpdateOutput:
        """
