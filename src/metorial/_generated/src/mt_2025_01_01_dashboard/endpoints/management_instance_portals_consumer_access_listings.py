...
class MetorialManagementInstancePortalsConsumerAccessListingsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'consumer-access-listings'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'consumer-access-listings', consumer_access_listing_id]
        )
