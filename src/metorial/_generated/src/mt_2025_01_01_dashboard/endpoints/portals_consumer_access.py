...
class MetorialPortalsConsumerAccessEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['portals', portal_id, 'consumer-access'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstancePortalsConsumerAccessListOutput.from_dict)

    def get(self, portal_id: str, consumer_access_id: str) -> DashboardInstancePortalsConsumerAccessGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['portals', portal_id, 'consumer-access', consumer_access_id]
        )
        return self._get(request).transform(mapDashboardInstancePortalsConsumerAccessGetOutput.from_dict)

    def create(self, portal_id: str, *, consumer_group_id: str, access: Union[Dict[str, Any], Dict[str, Any]], name: Optional[str] = None, description: Optional[str] = None, readme: Optional[str] = None) -> DashboardInstancePortalsConsumerAccessCreateOutput:
        """
    ...
    def update(self, portal_id: str, consumer_access_id: str, *, name: Optional[str] = None, description: Optional[str] = None, readme: Optional[str] = None) -> DashboardInstancePortalsConsumerAccessUpdateOutput:
        """
    ...
    def delete(self, portal_id: str, consumer_access_id: str) -> DashboardInstancePortalsConsumerAccessDeleteOutput:
        """
