...
class MetorialManagementOrganizationServiceAccountsCredentialsEndpoint(BaseMetorialEndpoint):
    """Create and manage service accounts for an organization"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, service_account_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None) -> DashboardOrganizationsServiceAccountsCredentialsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['organization', 'service-accounts', service_account_id, 'credentials'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsServiceAccountsCredentialsListOutput.from_dict)

    def get(self, service_account_id: str, service_account_credential_id: str) -> DashboardOrganizationsServiceAccountsCredentialsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['organization', 'service-accounts', service_account_id, 'credentials', service_account_credential_id]
        )
