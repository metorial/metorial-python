...
class MetorialPortalsConsumerProfilesEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, portal_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstancePortalsConsumerProfilesListOutput:
        """
