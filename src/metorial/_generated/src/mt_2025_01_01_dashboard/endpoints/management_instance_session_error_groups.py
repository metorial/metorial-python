...
class MetorialManagementInstanceSessionErrorGroupsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, type: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, session_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionErrorGroupsListOutput:
        """
    ...
    def get(self, instance_id: str, session_error_group_id: str) -> DashboardInstanceSessionErrorGroupsGetOutput:
        """
