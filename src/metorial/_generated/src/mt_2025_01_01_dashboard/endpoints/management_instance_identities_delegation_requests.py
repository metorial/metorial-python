...
class MetorialManagementInstanceIdentitiesDelegationRequestsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'identity-delegation-requests'],
            query=query_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'identity-delegation-requests', identity_delegation_request_id],
            query=query_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'identity-delegation-requests', identity_delegation_request_id, 'approve'],
            query=query_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'identity-delegation-requests', identity_delegation_request_id, 'deny'],
            query=query_dict
        )
