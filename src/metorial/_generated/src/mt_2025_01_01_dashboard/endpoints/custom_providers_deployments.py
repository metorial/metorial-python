...
class MetorialCustomProvidersDeploymentsEndpoint(BaseMetorialEndpoint):
    ...
    def get(self, custom_provider_deployment_id: str) -> DashboardInstanceCustomProvidersDeploymentsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['custom-provider-deployments', custom_provider_deployment_id]
        )
        return self._get(request).transform(mapDashboardInstanceCustomProvidersDeploymentsGetOutput.from_dict)

    def get_logs(self, custom_provider_deployment_id: str) -> DashboardInstanceCustomProvidersDeploymentsGetLogsOutput:
        """
    Get deployment logs
    ...
    """
        request = MetorialRequest(
            path=['custom-provider-deployments', custom_provider_deployment_id, 'logs']
        )
