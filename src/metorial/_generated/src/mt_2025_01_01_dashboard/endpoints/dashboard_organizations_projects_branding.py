...
class MetorialDashboardOrganizationsProjectsBrandingEndpoint(BaseMetorialEndpoint):
    """Read and write project information"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def get(self, organization_id: str, project_id: str) -> DashboardOrganizationsProjectsBrandingGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'projects', project_id, 'branding']
        )
        return self._get(request).transform(mapDashboardOrganizationsProjectsBrandingGetOutput.from_dict)

    def update(self, organization_id: str, project_id: str, *, name: Optional[str] = None, image_file_id: Optional[str] = None) -> DashboardOrganizationsProjectsBrandingUpdateOutput:
        """
