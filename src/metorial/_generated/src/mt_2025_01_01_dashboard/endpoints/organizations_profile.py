...
from ..resources import mapOrganizationsProfileGetOutput, OrganizationsProfileGetOutput, mapOrganizationsProfileUpdateOutput, OrganizationsProfileUpdateOutput, mapOrganizationsProfileUpdateBody, OrganizationsProfileUpdateBody
...
class MetorialOrganizationsProfileEndpoint(BaseMetorialEndpoint):
    ...
    def update(self, organization_id: str, *, name: Optional[str] = None, description: Optional[str] = None) -> OrganizationsProfileUpdateOutput:
        """
    Update own profile
