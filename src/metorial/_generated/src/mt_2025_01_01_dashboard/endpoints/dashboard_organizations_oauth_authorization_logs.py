...
class MetorialDashboardOrganizationsOauthAuthorizationLogsEndpoint(BaseMetorialEndpoint):
    """Inspect OAuth authorization requests for an organization"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, app_id: Optional[Union[str, List[str]]] = None, user_id: Optional[Union[str, List[str]]] = None) -> DashboardOrganizationsOauthAuthorizationLogsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'oauth', 'authorization-logs'],
            query=query_dict
        )
