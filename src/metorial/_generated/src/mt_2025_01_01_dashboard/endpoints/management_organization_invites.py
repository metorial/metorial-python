...
class MetorialManagementOrganizationInvitesEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsInvitesListOutput:
        """
    ...
    def update(self, invite_id: str, *, role: str) -> DashboardOrganizationsInvitesUpdateOutput:
        """
