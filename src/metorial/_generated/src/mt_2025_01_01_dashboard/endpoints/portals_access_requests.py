...
class MetorialPortalsAccessRequestsEndpoint(BaseMetorialEndpoint):
    """Review and resolve consumer access requests for a portal."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, portal_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, consumer_profile_id: Optional[Union[str, List[str]]] = None, search: Optional[str] = None) -> DashboardInstancePortalsAccessRequestsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['portals', portal_id, 'access-requests'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstancePortalsAccessRequestsListOutput.from_dict)

    def get(self, portal_id: str, consumer_access_request_id: str) -> DashboardInstancePortalsAccessRequestsGetOutput:
        """
    Get portal consumer access request
    Retrieves a consumer access request by ID.

    :param portal_id: str
    :param consumer_access_request_id: str
    :return: DashboardInstancePortalsAccessRequestsGetOutput
    """
        request = MetorialRequest(
            path=['portals', portal_id, 'access-requests', consumer_access_request_id]
        )
        return self._get(request).transform(mapDashboardInstancePortalsAccessRequestsGetOutput.from_dict)

    def update(self, portal_id: str, consumer_access_request_id: str, *, status: str, resolution_message: Optional[str] = None, consumer_group_id: Optional[str] = None) -> DashboardInstancePortalsAccessRequestsUpdateOutput:
        """
    Review portal consumer access request
    Approves or rejects a consumer access request.
