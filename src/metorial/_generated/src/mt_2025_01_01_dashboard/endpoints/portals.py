...
class MetorialPortalsEndpoint(BaseMetorialEndpoint):
    """Use Portals to create custom branded MCP server marketplaces for your organization."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstancePortalsListOutput:
        """
    List portals
    ...
    def get(self, portal_id: str) -> DashboardInstancePortalsGetOutput:
        """
    Get portal
    ...
    def create(self, *, name: str, description: Optional[str] = None, allowed_redirect_url_filters: Optional[List[Dict[str, Any]]] = None, session_expiry_time_in_seconds: Optional[float] = None) -> DashboardInstancePortalsCreateOutput:
        """
    Create portal
    ...
    def update(self, portal_id: str, *, name: Optional[str] = None, description: Optional[str] = None, allowed_redirect_url_filters: Optional[List[Dict[str, Any]]] = None, session_expiry_time_in_seconds: Optional[float] = None) -> DashboardInstancePortalsUpdateOutput:
        """
    Update portal
    ...
    def delete(self, portal_id: str) -> DashboardInstancePortalsDeleteOutput:
        """
    Delete portal
    Archives a portal.
