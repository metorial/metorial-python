...
class MetorialManagementOrganizationOauthInstallationsEndpoint(BaseMetorialEndpoint):
    """Inspect and revoke OAuth app installations for an organization"""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, app_id: Optional[Union[str, List[str]]] = None) -> DashboardOrganizationsOauthInstallationsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['organization', 'oauth', 'installations'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsOauthInstallationsListOutput.from_dict)

    def get(self, oauth_installation_id: str) -> DashboardOrganizationsOauthInstallationsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['organization', 'oauth', 'installations', oauth_installation_id]
        )
        return self._get(request).transform(mapDashboardOrganizationsOauthInstallationsGetOutput.from_dict)

    def revoke(self, oauth_installation_id: str) -> DashboardOrganizationsOauthInstallationsRevokeOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['organization', 'oauth', 'installations', oauth_installation_id, 'revoke']
        )
