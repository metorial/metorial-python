...
class MetorialPortalsConsumerGroupsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, portal_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, search: Optional[str] = None, id: Optional[str] = None) -> DashboardInstancePortalsConsumerGroupsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['portals', portal_id, 'consumer-groups'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstancePortalsConsumerGroupsListOutput.from_dict)

    def get(self, portal_id: str, consumer_group_id: str) -> DashboardInstancePortalsConsumerGroupsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['portals', portal_id, 'consumer-groups', consumer_group_id]
        )
    ...
    def delete(self, portal_id: str, consumer_group_id: str) -> DashboardInstancePortalsConsumerGroupsDeleteOutput:
        """
