...
class MetorialDashboardOrganizationsProjectsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, team_id: Optional[Union[str, List[str]]] = None) -> DashboardOrganizationsProjectsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'projects'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsProjectsListOutput.from_dict)

    def get(self, organization_id: str, project_id: str) -> DashboardOrganizationsProjectsGetOutput:
        """
    ...
    """
        ...
        return self._get(request).transform(mapDashboardOrganizationsProjectsGetOutput.from_dict)

    def create(self, organization_id: str, *, name: str) -> DashboardOrganizationsProjectsCreateOutput:
        """
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsProjectsCreateOutput.from_dict)

    def delete(self, organization_id: str, project_id: str) -> DashboardOrganizationsProjectsDeleteOutput:
        """
    ...
    """
        ...
        return self._delete(request).transform(mapDashboardOrganizationsProjectsDeleteOutput.from_dict)

    def update(self, organization_id: str, project_id: str, *, name: Optional[str] = None) -> DashboardOrganizationsProjectsUpdateOutput:
        """
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsProjectsUpdateOutput.from_dict)
