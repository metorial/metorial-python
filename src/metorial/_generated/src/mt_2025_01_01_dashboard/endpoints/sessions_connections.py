...
class MetorialSessionsConnectionsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, connection_state: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, session_id: Optional[Union[str, List[str]]] = None, session_provider_id: Optional[Union[str, List[str]]] = None, participant_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionsConnectionsListOutput:
        """
    ...
    def get(self, session_connection_id: str) -> DashboardInstanceSessionsConnectionsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['session-connections', session_connection_id]
        )
