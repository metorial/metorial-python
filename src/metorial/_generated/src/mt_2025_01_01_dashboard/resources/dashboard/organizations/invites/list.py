...
class mapDashboardOrganizationsInvitesListOutputItemsInviteLink:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutputItemsInviteLink:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutputItemsInviteLink, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsInvitesListOutputItemsOrganization:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutputItemsOrganization:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutputItemsOrganization, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInvitesListOutputItemsInvitedByTeams:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutputItemsInvitedByTeams:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutputItemsInvitedByTeams, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInvitesListOutputItemsInvitedBy:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutputItemsInvitedBy:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutputItemsInvitedBy, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInvitesListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutputItems:
        ...
        type=data.get('type'),
        email=data.get('email'),
        invite_link=mapDashboardOrganizationsInvitesListOutputItemsInviteLink.from_dict(data.get('invite_link')) if data.get('invite_link') else None,
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        ...
        organization=mapDashboardOrganizationsInvitesListOutputItemsOrganization.from_dict(data.get('organization')) if data.get('organization') else None,
        invited_by=mapDashboardOrganizationsInvitesListOutputItemsInvitedBy.from_dict(data.get('invited_by')) if data.get('invited_by') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInvitesListOutputPagination:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInvitesListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInvitesListOutput:
        ...
        items=[mapDashboardOrganizationsInvitesListOutputItems.from_dict(item) for item in data.get('items', []) if item],
        pagination=mapDashboardOrganizationsInvitesListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInvitesListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInvitesListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
