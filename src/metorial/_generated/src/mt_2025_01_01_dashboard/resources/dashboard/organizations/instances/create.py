...
class mapDashboardOrganizationsInstancesCreateOutputProject:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInstancesCreateOutputProject:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesCreateOutputProject, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsInstancesCreateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInstancesCreateOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        project=mapDashboardOrganizationsInstancesCreateOutputProject.from_dict(data.get('project')) if data.get('project') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesCreateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInstancesCreateBody:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesCreateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
