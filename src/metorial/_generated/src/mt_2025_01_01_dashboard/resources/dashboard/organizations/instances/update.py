...
class mapDashboardOrganizationsInstancesUpdateOutputProject:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInstancesUpdateOutputProject:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesUpdateOutputProject, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsInstancesUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInstancesUpdateOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        project=mapDashboardOrganizationsInstancesUpdateOutputProject.from_dict(data.get('project')) if data.get('project') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsInstancesUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
