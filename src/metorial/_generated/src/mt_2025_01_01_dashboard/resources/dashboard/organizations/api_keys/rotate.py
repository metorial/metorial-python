...
@dataclass
class DashboardOrganizationsApiKeysRotateOutputRevealInfo:
    until: datetime
    forever: bool
@dataclass
class DashboardOrganizationsApiKeysRotateOutput:
    ...
    reveal_info: Optional[DashboardOrganizationsApiKeysRotateOutputRevealInfo] = None
...
class mapDashboardOrganizationsApiKeysRotateOutputRevealInfo:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsApiKeysRotateOutputRevealInfo:
        return DashboardOrganizationsApiKeysRotateOutputRevealInfo(
        until=datetime.fromisoformat(data.get('until').replace('Z', '+00:00')) if data.get('until') else None,
        forever=data.get('forever')
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsApiKeysRotateOutputRevealInfo, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsApiKeysRotateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsApiKeysRotateOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        reveal_info=mapDashboardOrganizationsApiKeysRotateOutputRevealInfo.from_dict(data.get('reveal_info')) if data.get('reveal_info') else None
        )
