...
class mapDashboardOrganizationsTeamsRolesListOutputItems:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsTeamsRolesListOutputItems:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsTeamsRolesListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsTeamsRolesListOutputPagination:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsTeamsRolesListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsTeamsRolesListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsTeamsRolesListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsTeamsRolesListOutput:
        ...
        items=[mapDashboardOrganizationsTeamsRolesListOutputItems.from_dict(item) for item in data.get('items', []) if item],
        pagination=mapDashboardOrganizationsTeamsRolesListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsTeamsRolesListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsTeamsRolesListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsTeamsRolesListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
