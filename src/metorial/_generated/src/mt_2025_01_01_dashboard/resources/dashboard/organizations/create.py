...
class mapDashboardOrganizationsCreateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsCreateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsCreateBody:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsCreateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
