...
@dataclass
class DashboardOrganizationsApiKeysListOutputItemsRevealInfo:
    until: datetime
    forever: bool
@dataclass
class DashboardOrganizationsApiKeysListOutputItems:
    ...
    reveal_info: Optional[DashboardOrganizationsApiKeysListOutputItemsRevealInfo] = None
@dataclass
...
class mapDashboardOrganizationsApiKeysListOutputItemsRevealInfo:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsApiKeysListOutputItemsRevealInfo:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsApiKeysListOutputItemsRevealInfo, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsApiKeysListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsApiKeysListOutputItems:
        ...
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        reveal_info=mapDashboardOrganizationsApiKeysListOutputItemsRevealInfo.from_dict(data.get('reveal_info')) if data.get('reveal_info') else None
        )
