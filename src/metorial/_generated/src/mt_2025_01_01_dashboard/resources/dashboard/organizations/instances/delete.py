...
class mapDashboardOrganizationsInstancesDeleteOutputProject:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInstancesDeleteOutputProject:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesDeleteOutputProject, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsInstancesDeleteOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsInstancesDeleteOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        project=mapDashboardOrganizationsInstancesDeleteOutputProject.from_dict(data.get('project')) if data.get('project') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsInstancesDeleteOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
