...
class mapDashboardOrganizationsProjectsListOutputItems:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsProjectsListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardOrganizationsProjectsListOutputPagination:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsProjectsListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsProjectsListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsProjectsListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsProjectsListOutput:
        ...
        items=[mapDashboardOrganizationsProjectsListOutputItems.from_dict(item) for item in data.get('items', []) if item],
        pagination=mapDashboardOrganizationsProjectsListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsProjectsListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsProjectsListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsProjectsListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
