...
class mapDashboardBootOutputUser:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardBootOutputUser, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardBootOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardBootOutput:
        ...
        object=data.get('object'),
        user=mapDashboardBootOutputUser.from_dict(data.get('user')) if data.get('user') else None,
    ...
    @staticmethod
    def to_dict(value: Union[DashboardBootOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardBootBody:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardBootBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
