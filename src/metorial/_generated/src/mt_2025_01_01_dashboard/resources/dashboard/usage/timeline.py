...
class mapDashboardUsageTimelineOutputTimelineEntries:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardUsageTimelineOutputTimelineEntries, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardUsageTimelineOutputTimeline:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardUsageTimelineOutputTimeline:
        ...
        entries=[mapDashboardUsageTimelineOutputTimelineEntries.from_dict(item) for item in data.get('entries', []) if item]
        )

    @staticmethod
    def to_dict(value: Union[DashboardUsageTimelineOutputTimeline, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardUsageTimelineOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardUsageTimelineOutput:
        ...
        timeline=[mapDashboardUsageTimelineOutputTimeline.from_dict(item) for item in data.get('timeline', []) if item]
        )

    @staticmethod
    def to_dict(value: Union[DashboardUsageTimelineOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardUsageTimelineQueryEntities:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardUsageTimelineQueryEntities:
        return DashboardUsageTimelineQueryEntities(
        type=data.get('type'),
        id=data.get('id')
        )

    @staticmethod
    def to_dict(value: Union[DashboardUsageTimelineQueryEntities, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardUsageTimelineQueryInterval:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardUsageTimelineQueryInterval, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardUsageTimelineQuery:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardUsageTimelineQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
