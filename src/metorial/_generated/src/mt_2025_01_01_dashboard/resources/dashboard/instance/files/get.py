...
class mapDashboardInstanceFilesGetOutputPurpose:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceFilesGetOutputPurpose, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardInstanceFilesGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceFilesGetOutput:
        ...
        purpose=mapDashboardInstanceFilesGetOutputPurpose.from_dict(data.get('purpose')) if data.get('purpose') else None,
