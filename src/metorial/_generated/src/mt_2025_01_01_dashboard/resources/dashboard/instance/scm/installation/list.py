...
@dataclass
class DashboardInstanceScmInstallationListOutputItemsExternalAccount:
    id: str
    login: str
...
class DashboardInstanceScmInstallationListOutputItems:
    ...
    id: str
    provider: str
    external_account: DashboardInstanceScmInstallationListOutputItemsExternalAccount
    created_at: datetime
    updated_at: datetime
...
class mapDashboardInstanceScmInstallationListOutputItemsExternalAccount:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceScmInstallationListOutputItemsExternalAccount:
        return DashboardInstanceScmInstallationListOutputItemsExternalAccount(
        id=data.get('id'),
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceScmInstallationListOutputItemsExternalAccount, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapDashboardInstanceScmInstallationListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceScmInstallationListOutputItems:
        ...
        external_account=mapDashboardInstanceScmInstallationListOutputItemsExternalAccount.from_dict(data.get('external_account')) if data.get('external_account') else None,
