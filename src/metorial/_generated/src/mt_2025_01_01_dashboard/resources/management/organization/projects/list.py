...
class mapManagementOrganizationProjectsListOutputItems:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationProjectsListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationProjectsListOutputPagination:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationProjectsListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationProjectsListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationProjectsListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationProjectsListOutput:
        ...
        pagination=mapManagementOrganizationProjectsListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationProjectsListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationProjectsListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationProjectsListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
