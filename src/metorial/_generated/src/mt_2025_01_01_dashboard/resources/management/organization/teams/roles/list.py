...
class mapManagementOrganizationTeamsRolesListOutputItems:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationTeamsRolesListOutputItems:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationTeamsRolesListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationTeamsRolesListOutputPagination:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationTeamsRolesListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationTeamsRolesListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationTeamsRolesListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationTeamsRolesListOutput:
        ...
        items=[mapManagementOrganizationTeamsRolesListOutputItems.from_dict(item) for item in data.get('items', []) if item],
        pagination=mapManagementOrganizationTeamsRolesListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationTeamsRolesListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationTeamsRolesListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationTeamsRolesListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
