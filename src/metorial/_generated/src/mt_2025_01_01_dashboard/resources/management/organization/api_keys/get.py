...
@dataclass
class ManagementOrganizationApiKeysGetOutputRevealInfo:
    until: datetime
    forever: bool
@dataclass
class ManagementOrganizationApiKeysGetOutput:
    ...
    reveal_info: Optional[ManagementOrganizationApiKeysGetOutputRevealInfo] = None
...
class mapManagementOrganizationApiKeysGetOutputRevealInfo:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysGetOutputRevealInfo:
        return ManagementOrganizationApiKeysGetOutputRevealInfo(
        until=datetime.fromisoformat(data.get('until').replace('Z', '+00:00')) if data.get('until') else None,
        forever=data.get('forever')
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationApiKeysGetOutputRevealInfo, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationApiKeysGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysGetOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        reveal_info=mapManagementOrganizationApiKeysGetOutputRevealInfo.from_dict(data.get('reveal_info')) if data.get('reveal_info') else None
        )
