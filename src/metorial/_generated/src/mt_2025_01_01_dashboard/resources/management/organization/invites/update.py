...
class mapManagementOrganizationInvitesUpdateOutputInviteLink:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateOutputInviteLink:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesUpdateOutputInviteLink, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationInvitesUpdateOutputOrganization:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateOutputOrganization:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesUpdateOutputOrganization, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesUpdateOutputInvitedByTeams:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateOutputInvitedByTeams:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesUpdateOutputInvitedByTeams, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesUpdateOutputInvitedBy:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateOutputInvitedBy:
        ...
        image_url=data.get('image_url'),
        teams=[mapManagementOrganizationInvitesUpdateOutputInvitedByTeams.from_dict(item) for item in data.get('teams', []) if item],
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesUpdateOutputInvitedBy, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesUpdateOutput:
        ...
        type=data.get('type'),
        email=data.get('email'),
        invite_link=mapManagementOrganizationInvitesUpdateOutputInviteLink.from_dict(data.get('invite_link')) if data.get('invite_link') else None,
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        ...
        organization=mapManagementOrganizationInvitesUpdateOutputOrganization.from_dict(data.get('organization')) if data.get('organization') else None,
        invited_by=mapManagementOrganizationInvitesUpdateOutputInvitedBy.from_dict(data.get('invited_by')) if data.get('invited_by') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
