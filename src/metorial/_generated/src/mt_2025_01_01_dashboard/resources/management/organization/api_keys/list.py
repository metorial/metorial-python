...
@dataclass
class ManagementOrganizationApiKeysListOutputItemsRevealInfo:
    until: datetime
    forever: bool
@dataclass
class ManagementOrganizationApiKeysListOutputItems:
    ...
    reveal_info: Optional[ManagementOrganizationApiKeysListOutputItemsRevealInfo] = None
@dataclass
...
class mapManagementOrganizationApiKeysListOutputItemsRevealInfo:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysListOutputItemsRevealInfo:
        return ManagementOrganizationApiKeysListOutputItemsRevealInfo(
        until=datetime.fromisoformat(data.get('until').replace('Z', '+00:00')) if data.get('until') else None,
        forever=data.get('forever')
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationApiKeysListOutputItemsRevealInfo, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationApiKeysListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysListOutputItems:
        ...
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        reveal_info=mapManagementOrganizationApiKeysListOutputItemsRevealInfo.from_dict(data.get('reveal_info')) if data.get('reveal_info') else None
        )
