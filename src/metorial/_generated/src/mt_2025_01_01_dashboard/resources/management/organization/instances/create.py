...
class mapManagementOrganizationInstancesCreateOutputProject:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInstancesCreateOutputProject:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInstancesCreateOutputProject, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationInstancesCreateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInstancesCreateOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        project=mapManagementOrganizationInstancesCreateOutputProject.from_dict(data.get('project')) if data.get('project') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInstancesCreateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInstancesCreateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInstancesCreateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
