...
class mapManagementOrganizationInvitesDeleteOutputInviteLink:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesDeleteOutputInviteLink:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesDeleteOutputInviteLink, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationInvitesDeleteOutputOrganization:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesDeleteOutputOrganization:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesDeleteOutputOrganization, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesDeleteOutputInvitedByTeams:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesDeleteOutputInvitedByTeams:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesDeleteOutputInvitedByTeams, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesDeleteOutputInvitedBy:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesDeleteOutputInvitedBy:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesDeleteOutputInvitedBy, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInvitesDeleteOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInvitesDeleteOutput:
        ...
        type=data.get('type'),
        email=data.get('email'),
        invite_link=mapManagementOrganizationInvitesDeleteOutputInviteLink.from_dict(data.get('invite_link')) if data.get('invite_link') else None,
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        ...
        organization=mapManagementOrganizationInvitesDeleteOutputOrganization.from_dict(data.get('organization')) if data.get('organization') else None,
        invited_by=mapManagementOrganizationInvitesDeleteOutputInvitedBy.from_dict(data.get('invited_by')) if data.get('invited_by') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInvitesDeleteOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
