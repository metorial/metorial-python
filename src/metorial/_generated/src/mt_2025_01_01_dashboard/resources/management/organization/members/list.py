...
class mapManagementOrganizationMembersListOutputItemsActorTeams:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationMembersListOutputItemsActorTeams:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersListOutputItemsActorTeams, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationMembersListOutputItemsActor:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationMembersListOutputItemsActor:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersListOutputItemsActor, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationMembersListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationMembersListOutputItems:
        ...
        actor=mapManagementOrganizationMembersListOutputItemsActor.from_dict(data.get('actor')) if data.get('actor') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationMembersListOutputPagination:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationMembersListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationMembersListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationMembersListOutput:
        ...
        items=[mapManagementOrganizationMembersListOutputItems.from_dict(item) for item in data.get('items', []) if item],
        pagination=mapManagementOrganizationMembersListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationMembersListQuery:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersListQuery, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
