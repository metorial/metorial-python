...
class mapManagementOrganizationInstancesUpdateOutputProject:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInstancesUpdateOutputProject:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInstancesUpdateOutputProject, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationInstancesUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationInstancesUpdateOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None,
        project=mapManagementOrganizationInstancesUpdateOutputProject.from_dict(data.get('project')) if data.get('project') else None
        )

    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInstancesUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationInstancesUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationInstancesUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
