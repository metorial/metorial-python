...
@dataclass
class ManagementOrganizationApiKeysRotateOutputRevealInfo:
    until: datetime
    forever: bool
@dataclass
class ManagementOrganizationApiKeysRotateOutput:
    ...
    reveal_info: Optional[ManagementOrganizationApiKeysRotateOutputRevealInfo] = None
...
class mapManagementOrganizationApiKeysRotateOutputRevealInfo:
    @staticmethod
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationApiKeysRotateOutputRevealInfo, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationApiKeysRotateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysRotateOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        reveal_info=mapManagementOrganizationApiKeysRotateOutputRevealInfo.from_dict(data.get('reveal_info')) if data.get('reveal_info') else None
        )
