...
class mapManagementOrganizationMembersUpdateOutputActorTeams:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationMembersUpdateOutputActorTeams:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersUpdateOutputActorTeams, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationMembersUpdateOutputActor:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersUpdateOutputActor, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationMembersUpdateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersUpdateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationMembersUpdateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationMembersUpdateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
