...
@dataclass
class ManagementOrganizationApiKeysRevokeOutputRevealInfo:
    until: datetime
    forever: bool
@dataclass
class ManagementOrganizationApiKeysRevokeOutput:
    ...
    reveal_info: Optional[ManagementOrganizationApiKeysRevokeOutputRevealInfo] = None
...
class mapManagementOrganizationApiKeysRevokeOutputRevealInfo:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysRevokeOutputRevealInfo:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationApiKeysRevokeOutputRevealInfo, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapManagementOrganizationApiKeysRevokeOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementOrganizationApiKeysRevokeOutput:
        ...
        created_at=datetime.fromisoformat(data.get('created_at').replace('Z', '+00:00')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at').replace('Z', '+00:00')) if data.get('updated_at') else None,
        reveal_info=mapManagementOrganizationApiKeysRevokeOutputRevealInfo.from_dict(data.get('reveal_info')) if data.get('reveal_info') else None
        )
