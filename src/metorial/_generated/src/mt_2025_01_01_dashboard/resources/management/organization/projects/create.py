...
class mapManagementOrganizationProjectsCreateOutput:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationProjectsCreateOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementOrganizationProjectsCreateBody:
    ...
    @staticmethod
    def to_dict(value: Union[ManagementOrganizationProjectsCreateBody, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
