...
@dataclass
class ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview:
    object: str
    id: str
    is_default: bool
    provider_id: str
...
class ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfig:
    ...
    description: Optional[str] = None
    metadata: Optional[Dict[str, Any]] = None
    deployment_preview: Optional[ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview] = None
...
class mapManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview:
        return ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview(
    ...
    @staticmethod
    def to_dict(value: Union[ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfig:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfig:
        ...
        description=data.get('description'),
        metadata=data.get('metadata'),
        deployment_preview=mapManagementInstanceProviderDeploymentsAuthConfigsImportsCreateOutputAuthConfigDeploymentPreview.from_dict(data.get('deployment_preview')) if data.get('deployment_preview') else None,
