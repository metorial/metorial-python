...
@dataclass
class ManagementInstanceProviderListingsListQueryCapabilities:
...
class ManagementInstanceProviderListingsListQuery:
    ...
    capabilities: Optional[ManagementInstanceProviderListingsListQueryCapabilities] = None
...
class mapManagementInstanceProviderListingsListQuery:
    ...
    def from_dict(data: Dict[str, Any]) -> ManagementInstanceProviderListingsListQuery:
        ...
        capabilities=mapManagementInstanceProviderListingsListQueryCapabilities.from_dict(data.get('capabilities')) if data.get('capabilities') else None,
        is_public=data.get('is_public'),
