...
@dataclass
class ProviderDeploymentsAuthConfigsDeleteOutputDeployment:
    object: str
    id: str
    is_default: bool
    provider_id: str
...
class ProviderDeploymentsAuthConfigsDeleteOutput:
    ...
    description: Optional[str] = None
    metadata: Optional[Dict[str, Any]] = None
    deployment: Optional[ProviderDeploymentsAuthConfigsDeleteOutputDeployment] = None
    credentials: Optional[ProviderDeploymentsAuthConfigsDeleteOutputCredentials] = None


class mapProviderDeploymentsAuthConfigsDeleteOutputDeployment:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ProviderDeploymentsAuthConfigsDeleteOutputDeployment:
        return ProviderDeploymentsAuthConfigsDeleteOutputDeployment(
    ...
    @staticmethod
    def to_dict(value: Union[ProviderDeploymentsAuthConfigsDeleteOutputDeployment, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
