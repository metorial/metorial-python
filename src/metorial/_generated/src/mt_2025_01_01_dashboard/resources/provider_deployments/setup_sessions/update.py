...
class ProviderDeploymentsSetupSessionsUpdateOutputAuthConfig:
    ...
    description: Optional[str] = None
    metadata: Optional[Dict[str, Any]] = None
    deployment: Optional[ProviderDeploymentsSetupSessionsUpdateOutputAuthConfigDeployment] = None
...
class mapProviderDeploymentsSetupSessionsUpdateOutputAuthConfigDeployment:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ProviderDeploymentsSetupSessionsUpdateOutputAuthConfigDeployment:
        return ProviderDeploymentsSetupSessionsUpdateOutputAuthConfigDeployment(
        object=data.get('object'),
        id=data.get('id'),
        is_default=data.get('is_default'),
        name=data.get('name'),
    ...
    @staticmethod
    def to_dict(value: Union[ProviderDeploymentsSetupSessionsUpdateOutputAuthConfigDeployment, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
