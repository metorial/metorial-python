...
class ConsumersProfilesGetOutputGroups:
    ...
    assigned_via: str
@dataclass
class ConsumersProfilesGetOutputSurfaceAuth:
    object: str
    session_expiry_time_in_seconds: float
    email_whitelist: List[str]
@dataclass
class ConsumersProfilesGetOutputSurface:
    object: str
    id: str
    status: str
    name: str
    auth: ConsumersProfilesGetOutputSurfaceAuth
    created_at: datetime
    updated_at: datetime
    description: Optional[str] = None
@dataclass
class ConsumersProfilesGetOutput:
    ...
    created_at: datetime
    updated_at: datetime
    surface: ConsumersProfilesGetOutputSurface
