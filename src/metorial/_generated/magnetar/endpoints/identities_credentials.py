...
class MetorialIdentitiesCredentialsEndpoint(BaseMetorialEndpoint):
    """Identity credentials bind an identity to concrete provider deployment, config, and auth resources."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, agent_id: Optional[Union[str, List[str]]] = None, actor_id: Optional[Union[str, List[str]]] = None, identity_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, provider_deployment_id: Optional[Union[str, List[str]]] = None, provider_config_id: Optional[Union[str, List[str]]] = None, provider_auth_config_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceIdentitiesCredentialsListOutput:
        """
    ...
    def get(self, identity_credential_id: str) -> DashboardInstanceIdentitiesCredentialsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['identity-credentials', identity_credential_id]
        )
        return self._get(request).transform(mapDashboardInstanceIdentitiesCredentialsGetOutput.from_dict)

    def create(self, *, identity_id: str, deployment_id: Optional[str] = None, config_id: Optional[str] = None, auth_config_id: Optional[str] = None, delegation_config_id: Optional[str] = None) -> DashboardInstanceIdentitiesCredentialsCreateOutput:
        """
    ...
    def update(self, identity_credential_id: str, *, delegation_config_id: str) -> DashboardInstanceIdentitiesCredentialsUpdateOutput:
        """
    ...
    def delete(self, identity_credential_id: str) -> DashboardInstanceIdentitiesCredentialsDeleteOutput:
        """
