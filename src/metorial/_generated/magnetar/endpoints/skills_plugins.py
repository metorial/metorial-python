...
class MetorialSkillsPluginsEndpoint(BaseMetorialEndpoint):
    """Manage skill plugins for an instance."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, skill_marketplace_id: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, category: Optional[str] = None, search: Optional[str] = None, skill_configuration_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceSkillsPluginsListOutput:
        """
    List skill plugins
    ...
    def get(self, skill_plugin_id: str) -> DashboardInstanceSkillsPluginsGetOutput:
        """
    Get skill plugin
    ...
    """
        request = MetorialRequest(
            path=['skill-plugins', skill_plugin_id]
        )
    ...
    def update(self, skill_plugin_id: str, *, name: Optional[str] = None, description: Optional[str] = None, long_description: Optional[str] = None, category: Optional[str] = None, image_file_id: Optional[str] = None, skill_configuration_id: Optional[str] = None) -> DashboardInstanceSkillsPluginsUpdateOutput:
        """
    Update skill plugin
    ...
    def archive(self, skill_plugin_id: str) -> DashboardInstanceSkillsPluginsArchiveOutput:
        """
    ...
    def sync(self, skill_plugin_id: str) -> DashboardInstanceSkillsPluginsSyncOutput:
        """
    Sync skill plugin
    ...
    """
        request = MetorialRequest(
            path=['skill-plugins', skill_plugin_id, 'sync']
        )
