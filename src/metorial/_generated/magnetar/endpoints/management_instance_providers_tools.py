...
class MetorialManagementInstanceProvidersToolsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'providers', provider_id, 'tools'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'providers', provider_id, 'tools', provider_tool_id]
        )
