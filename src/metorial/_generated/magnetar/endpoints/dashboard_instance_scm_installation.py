...
class MetorialDashboardInstanceScmInstallationEndpoint(BaseMetorialEndpoint):
    """Manage source control management installations (e.g. GitHub App installations)."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceScmInstallationListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'scm', 'installations'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceScmInstallationListOutput.from_dict)

    def create(self, instance_id: str, *, provider: Optional[str] = None, redirect_url: Optional[str] = None) -> DashboardInstanceScmInstallationCreateOutput:
        """
