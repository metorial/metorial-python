...
class MetorialProviderDeploymentsAuthConfigsImportsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, provider_deployment_id: str, provider_auth_config_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceProviderDeploymentsAuthConfigsImportsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'imports'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsAuthConfigsImportsListOutput.from_dict)

    def get(self, provider_deployment_id: str, provider_auth_config_id: str, provider_auth_import_id: str) -> DashboardInstanceProviderDeploymentsAuthConfigsImportsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'imports', provider_auth_import_id]
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsAuthConfigsImportsGetOutput.from_dict)

    def create(self, provider_deployment_id: str, provider_auth_config_id: str, *, note: str, value: Dict[str, Any], metadata: Optional[Dict[str, Any]] = None, provider_auth_method_id: Optional[str] = None) -> DashboardInstanceProviderDeploymentsAuthConfigsImportsCreateOutput:
        """
    ...
    def get_schema(self, provider_deployment_id: str, provider_auth_config_id: str) -> DashboardInstanceProviderDeploymentsAuthConfigsImportsGetSchemaOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'imports', 'schema']
        )
