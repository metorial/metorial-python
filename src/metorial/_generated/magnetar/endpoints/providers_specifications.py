...
class MetorialProvidersSpecificationsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, provider_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceProvidersSpecificationsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['providers', provider_id, 'specifications'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProvidersSpecificationsListOutput.from_dict)

    def get(self, provider_id: str, provider_specification_id: str) -> DashboardInstanceProvidersSpecificationsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['providers', provider_id, 'specifications', provider_specification_id]
        )
