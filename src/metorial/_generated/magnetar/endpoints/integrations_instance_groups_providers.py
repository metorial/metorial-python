...
class MetorialIntegrationsInstanceGroupsProvidersEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, integration_instance_group_id: Optional[Union[str, List[str]]] = None, integration_id: Optional[Union[str, List[str]]] = None, integration_instance_id: Optional[Union[str, List[str]]] = None, integration_instance_provider_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, integration_provider_id: Optional[Union[str, List[str]]] = None, provider_deployment_id: Optional[Union[str, List[str]]] = None, provider_config_id: Optional[Union[str, List[str]]] = None, provider_auth_config_id: Optional[Union[str, List[str]]] = None, session_template_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstanceGroupsProvidersListOutput:
        """
    ...
    def get(self, integration_instance_group_provider_id: str) -> DashboardInstanceIntegrationsInstanceGroupsProvidersGetOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['integration-instance-groups', integration_instance_group_id, 'providers', integration_instance_provider_id],
            body=body_dict
        )
        return self._put(request).transform(mapDashboardInstanceIntegrationsInstanceGroupsProvidersSetOutput.from_dict)

    def delete(self, integration_instance_group_provider_id: str) -> DashboardInstanceIntegrationsInstanceGroupsProvidersDeleteOutput:
        """
