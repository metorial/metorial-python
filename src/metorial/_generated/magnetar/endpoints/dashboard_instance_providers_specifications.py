...
class MetorialDashboardInstanceProvidersSpecificationsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'providers', provider_id, 'specifications'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'providers', provider_id, 'specifications', provider_specification_id]
        )
