...
class MetorialManagementOrganizationTeamsEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['organization', 'teams', team_id]
        )
        return self._get(request).transform(mapDashboardOrganizationsTeamsGetOutput.from_dict)

    def update(self, team_id: str, *, name: Optional[str] = None, description: Optional[str] = None) -> DashboardOrganizationsTeamsUpdateOutput:
        """
    Update team
    ...
    def create(self, *, name: str, description: Optional[str] = None) -> DashboardOrganizationsTeamsCreateOutput:
        """
