...
class MetorialManagementInstancePortalsAuthSsoTenantsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'auth', 'sso-tenants'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'portals', portal_id, 'auth', 'sso-tenants', sso_tenant_id, 'setup']
        )
