...
class MetorialSessionsConnectionsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, session_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[str] = None, connection_state: Optional[str] = None, session_provider_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionsConnectionsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['sessions', session_id, 'connections'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSessionsConnectionsListOutput.from_dict)

    def get(self, session_id: str, session_connection_id: str) -> DashboardInstanceSessionsConnectionsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['sessions', session_id, 'connections', session_connection_id]
        )
