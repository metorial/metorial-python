...
class MetorialManagementInstanceSessionsProviderRunsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'sessions', session_id, 'provider-runs'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'sessions', session_id, 'provider-runs', provider_run_id]
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'sessions', session_id, 'provider-runs', provider_run_id, 'logs']
        )
