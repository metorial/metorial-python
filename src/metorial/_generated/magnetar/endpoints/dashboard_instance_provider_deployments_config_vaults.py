...
class MetorialDashboardInstanceProviderDeploymentsConfigVaultsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-deployments', provider_deployment_id, 'config-vaults'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-deployments', provider_deployment_id, 'config-vaults', provider_config_vault_id]
        )
