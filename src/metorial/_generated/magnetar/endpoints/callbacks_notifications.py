...
class MetorialCallbacksNotificationsEndpoint(BaseMetorialEndpoint):
    """Read callback notification deliveries."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, callback_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, destination_id: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None) -> DashboardInstanceCallbacksNotificationsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['callbacks', callback_id, 'notifications'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceCallbacksNotificationsListOutput.from_dict)

    def get(self, callback_id: str, callback_notification_id: str) -> DashboardInstanceCallbacksNotificationsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['callbacks', callback_id, 'notifications', callback_notification_id]
        )
