...
class MetorialManagementInstanceNetworkPoliciesRulesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'network-policies', network_policy_id, 'rules'],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'network-policies', network_policy_id, 'rules', rule_id],
            body=body_dict
        )
