...
class MetorialConversationsMessagesEndpoint(BaseMetorialEndpoint):
    ...
    def handoff_responses(self, assistant_conversation_id: str, assistant_message_id: str, *, responses: List[Dict[str, Any]]) -> DashboardInstanceConversationsMessagesHandoffResponsesOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['conversations', assistant_conversation_id, 'messages', assistant_message_id, 'handoff-responses'],
            body=body_dict
        )
