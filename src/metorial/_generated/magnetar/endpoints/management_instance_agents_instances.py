...
class MetorialManagementInstanceAgentsInstancesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'agents', agent_id, 'instances'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'agents', agent_id, 'instances', agent_instance_id]
        )
