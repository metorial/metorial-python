...
class MetorialManagementInstanceSessionErrorGroupsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, type: Optional[str] = None, session_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionErrorGroupsListOutput:
        """
