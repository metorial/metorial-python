...
class MetorialProviderDeploymentsAuthConfigsExportsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, provider_deployment_id: str, provider_auth_config_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceProviderDeploymentsAuthConfigsExportsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'exports'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsAuthConfigsExportsListOutput.from_dict)

    def get(self, provider_deployment_id: str, provider_auth_config_id: str, provider_auth_export_id: str) -> DashboardInstanceProviderDeploymentsAuthConfigsExportsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'exports', provider_auth_export_id]
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsAuthConfigsExportsGetOutput.from_dict)

    def create(self, provider_deployment_id: str, provider_auth_config_id: str, *, note: str, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceProviderDeploymentsAuthConfigsExportsCreateOutput:
        """
