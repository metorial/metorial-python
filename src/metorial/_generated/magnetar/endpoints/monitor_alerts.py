...
class MetorialMonitorAlertsEndpoint(BaseMetorialEndpoint):
    """Monitor alerts represent detected prompt-injection or schema-change events."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, monitor_id: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, target: Optional[Union[str, List[str]]] = None, source: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, proto_guard_alert_id: Optional[Union[str, List[str]]] = None, proto_guard_run_id: Optional[Union[str, List[str]]] = None, proto_guard_filter_id: Optional[Union[str, List[str]]] = None, specification_change_notification_id: Optional[Union[str, List[str]]] = None, session_id: Optional[Union[str, List[str]]] = None, session_message_id: Optional[Union[str, List[str]]] = None, session_connection_id: Optional[Union[str, List[str]]] = None, provider_run_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, resolved_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceMonitorAlertsListOutput:
        """
    List monitor alerts
    ...
    def get(self, monitor_alert_id: str) -> DashboardInstanceMonitorAlertsGetOutput:
        """
    Get monitor alert
    ...
    """
        request = MetorialRequest(
            path=['monitor-alerts', monitor_alert_id]
        )
        return self._get(request).transform(mapDashboardInstanceMonitorAlertsGetOutput.from_dict)

    def viewed(self, monitor_alert_id: str) -> DashboardInstanceMonitorAlertsViewedOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['monitor-alerts', monitor_alert_id, 'viewed']
        )
        return self._post(request).transform(mapDashboardInstanceMonitorAlertsViewedOutput.from_dict)

    def resolve(self, monitor_alert_id: str) -> DashboardInstanceMonitorAlertsResolveOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['monitor-alerts', monitor_alert_id, 'resolve']
        )
        return self._post(request).transform(mapDashboardInstanceMonitorAlertsResolveOutput.from_dict)

    def unresolve(self, monitor_alert_id: str) -> DashboardInstanceMonitorAlertsUnresolveOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['monitor-alerts', monitor_alert_id, 'unresolve']
        )
