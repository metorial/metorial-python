...
class MetorialDashboardInstanceCallbacksNotificationsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'callbacks', callback_id, 'notifications'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'callbacks', callback_id, 'notifications', callback_notification_id]
        )
