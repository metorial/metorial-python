...
class MetorialDashboardInstanceStoresItemsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'stores', store_id, 'items'],
            body=body_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'stores', store_id, 'items', item_id]
        )
