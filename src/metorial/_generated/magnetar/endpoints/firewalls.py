...
class MetorialFirewallsEndpoint(BaseMetorialEndpoint):
    """Manage firewalls and their attached network policies."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, slug: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, network_id: Optional[Union[str, List[str]]] = None, enclave_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, network_policy_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceFirewallsListOutput:
        """
    List firewalls
    ...
    def get(self, firewall_id: str) -> DashboardInstanceFirewallsGetOutput:
        """
    Get firewall
    ...
    def create(self, *, name: str, network_id: str, description: Optional[str] = None, slug: Optional[str] = None, bindings: Optional[List[Dict[str, Any]]] = None, network_policy_ids: Optional[List[str]] = None) -> DashboardInstanceFirewallsCreateOutput:
        """
    Create firewall
    ...
    def update(self, firewall_id: str, *, name: Optional[str] = None, description: Optional[str] = None, slug: Optional[str] = None, network_policy_ids: Optional[List[str]] = None) -> DashboardInstanceFirewallsUpdateOutput:
        """
    Update firewall
    ...
    def delete(self, firewall_id: str) -> DashboardInstanceFirewallsDeleteOutput:
        """
    Delete firewall
    Archives a firewall.
