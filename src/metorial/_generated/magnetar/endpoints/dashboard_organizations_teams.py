...
class MetorialDashboardOrganizationsTeamsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, organization_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardOrganizationsTeamsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'organizations', organization_id, 'teams'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardOrganizationsTeamsListOutput.from_dict)

    def get(self, organization_id: str, team_id: str) -> DashboardOrganizationsTeamsGetOutput:
        """
    Get team
    ...
    """
        ...
        return self._get(request).transform(mapDashboardOrganizationsTeamsGetOutput.from_dict)

    def update(self, organization_id: str, team_id: str, *, name: Optional[str] = None, description: Optional[str] = None) -> DashboardOrganizationsTeamsUpdateOutput:
        """
    Update team
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsTeamsUpdateOutput.from_dict)

    def create(self, organization_id: str, *, name: str, description: Optional[str] = None) -> DashboardOrganizationsTeamsCreateOutput:
        """
    ...
    """
        ...
        return self._post(request).transform(mapDashboardOrganizationsTeamsCreateOutput.from_dict)

    def permissions(self, organization_id: str) -> DashboardOrganizationsTeamsPermissionsOutput:
        """
    Get team
    Get the information of a specific team
