...
class MetorialDashboardInstanceAgentsInstancesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'agents', agent_id, 'instances'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceAgentsInstancesListOutput.from_dict)

    def get(self, instance_id: str, agent_id: str, agent_instance_id: str) -> DashboardInstanceAgentsInstancesGetOutput:
        """
    Get agent instance
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'agents', agent_id, 'instances', agent_instance_id]
        )
