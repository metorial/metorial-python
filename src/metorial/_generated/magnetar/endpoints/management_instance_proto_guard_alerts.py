...
class MetorialManagementInstanceProtoGuardAlertsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'protoguard-alerts'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'protoguard-alerts', proto_guard_alert_id]
        )
