...
class MetorialManagementInstanceFirewallBindingsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'firewall-bindings'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'firewall-bindings', firewall_binding_id]
        )
