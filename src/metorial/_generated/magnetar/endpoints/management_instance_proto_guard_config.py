...
class MetorialManagementInstanceProtoGuardConfigEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'protoguard-config']
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'protoguard-config', 'filters', filter_id],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'protoguard-config', 'alert-filter-count-threshold'],
            body=body_dict
        )
