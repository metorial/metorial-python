...
class MetorialIntegrationsInstancesProvidersEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, integration_id: Optional[Union[str, List[str]]] = None, integration_instance_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, integration_provider_id: Optional[Union[str, List[str]]] = None, provider_deployment_id: Optional[Union[str, List[str]]] = None, provider_config_id: Optional[Union[str, List[str]]] = None, provider_auth_config_id: Optional[Union[str, List[str]]] = None, session_template_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstancesProvidersListOutput:
        """
    ...
    def get(self, integration_instance_provider_id: str) -> DashboardInstanceIntegrationsInstancesProvidersGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['integration-instance-providers', integration_instance_provider_id]
        )
        return self._get(request).transform(mapDashboardInstanceIntegrationsInstancesProvidersGetOutput.from_dict)

    def set(self, integration_instance_id: str, provider_id: str, *, provider_deployment_id: Optional[str] = None, provider_config_id: Optional[str] = None, provider_auth_config_id: Optional[str] = None, tool_filters: Optional[Union[Union[Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any]], List[Union[Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any], Dict[str, Any]]]]] = None, is_override_tool_filter: Optional[bool] = None) -> DashboardInstanceIntegrationsInstancesProvidersSetOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['integration-instances', integration_instance_id, 'providers', provider_id],
            body=body_dict
        )
