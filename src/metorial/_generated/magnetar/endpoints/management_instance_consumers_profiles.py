...
class MetorialManagementInstanceConsumersProfilesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'consumers', consumer_id, 'profiles'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'consumers', consumer_id, 'profiles', consumer_profile_id]
        )
