...
class MetorialDashboardInstanceSessionsProviderRunsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, session_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[str] = None, provider_id: Optional[Union[str, List[str]]] = None, session_provider_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionsProviderRunsListOutput:
        """
    List provider runs
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'sessions', session_id, 'provider-runs'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSessionsProviderRunsListOutput.from_dict)

    def get(self, instance_id: str, session_id: str, provider_run_id: str) -> DashboardInstanceSessionsProviderRunsGetOutput:
        """
    Get provider run
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'sessions', session_id, 'provider-runs', provider_run_id]
        )
        return self._get(request).transform(mapDashboardInstanceSessionsProviderRunsGetOutput.from_dict)

    def get_logs(self, instance_id: str, session_id: str, provider_run_id: str) -> DashboardInstanceSessionsProviderRunsGetLogsOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'sessions', session_id, 'provider-runs', provider_run_id, 'logs']
        )
