...
class MetorialSessionsMessagesEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, session_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, type: Optional[str] = None, session_provider_id: Optional[Union[str, List[str]]] = None, provider_run_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionsMessagesListOutput:
        """
    ...
    def get(self, session_id: str, session_message_id: str) -> DashboardInstanceSessionsMessagesGetOutput:
        """
    Get session message
    ...
    """
        request = MetorialRequest(
            path=['sessions', session_id, 'messages', session_message_id]
        )
