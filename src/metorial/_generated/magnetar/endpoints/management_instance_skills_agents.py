...
class MetorialManagementInstanceSkillsAgentsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'agents'],
            body=body_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'agents', skill_agent_id]
        )
