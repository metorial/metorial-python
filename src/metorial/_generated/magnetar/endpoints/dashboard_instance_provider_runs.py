...
class MetorialDashboardInstanceProviderRunsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-runs'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProviderRunsListOutput.from_dict)

    def get(self, instance_id: str, provider_run_id: str) -> DashboardInstanceProviderRunsGetOutput:
        """
    Get provider run
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-runs', provider_run_id]
        )
        return self._get(request).transform(mapDashboardInstanceProviderRunsGetOutput.from_dict)

    def get_logs(self, instance_id: str, provider_run_id: str) -> DashboardInstanceProviderRunsGetLogsOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-runs', provider_run_id, 'logs']
        )
