...
class MetorialManagementInstanceIntegrationsProvidersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-providers'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-providers', integration_provider_id]
        )
