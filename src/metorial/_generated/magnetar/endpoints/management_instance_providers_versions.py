...
class MetorialManagementInstanceProvidersVersionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'providers', provider_id, 'versions'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'providers', provider_id, 'versions', provider_version_id]
        )
