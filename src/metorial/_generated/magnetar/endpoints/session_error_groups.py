...
class MetorialSessionErrorGroupsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, type: Optional[str] = None, session_id: Optional[Union[str, List[str]]] = None) -> DashboardInstanceSessionErrorGroupsListOutput:
        """
