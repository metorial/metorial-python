...
class MetorialDashboardInstanceConsumerSurfacesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'consumer-surfaces'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'consumer-surfaces', consumer_surface_id]
        )
