...
class MetorialDashboardInstanceProviderDeploymentsAuthConfigsImportsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-auth-config-imports'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsAuthConfigsImportsListOutput.from_dict)

    def get(self, instance_id: str, provider_auth_import_id: str) -> DashboardInstanceProviderDeploymentsAuthConfigsImportsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-auth-config-imports', provider_auth_import_id]
        )
    ...
    def get_schema(self, instance_id: str, *, provider_id: Optional[str] = None, provider_deployment_id: Optional[str] = None, provider_auth_config_id: Optional[str] = None, provider_auth_method_id: Optional[str] = None) -> DashboardInstanceProviderDeploymentsAuthConfigsImportsGetSchemaOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-auth-config-imports', 'schema'],
            query=query_dict
        )
