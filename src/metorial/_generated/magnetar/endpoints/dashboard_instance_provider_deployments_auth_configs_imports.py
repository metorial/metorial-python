...
class MetorialDashboardInstanceProviderDeploymentsAuthConfigsImportsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'imports'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'imports', provider_auth_import_id]
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'provider-deployments', provider_deployment_id, 'auth-configs', provider_auth_config_id, 'imports', 'schema']
        )
