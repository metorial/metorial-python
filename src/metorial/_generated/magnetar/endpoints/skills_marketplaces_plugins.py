...
class MetorialSkillsMarketplacesPluginsEndpoint(BaseMetorialEndpoint):
    """Manage plugin links for skill marketplaces."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, skill_marketplace_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, skill_plugin_id: Optional[Union[str, List[str]]] = None, status: Optional[Union[str, List[str]]] = None, skill_configuration_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceSkillsMarketplacesPluginsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['skill-marketplaces', skill_marketplace_id, 'plugins'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSkillsMarketplacesPluginsListOutput.from_dict)

    def add(self, skill_marketplace_id: str, *, skill_plugin_id: str, skill_configuration_id: Optional[str] = None, identifier: Optional[str] = None) -> DashboardInstanceSkillsMarketplacesPluginsAddOutput:
        """
    ...
    def get(self, skill_marketplace_id: str, skill_marketplace_plugin_id: str) -> DashboardInstanceSkillsMarketplacesPluginsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['skill-marketplaces', skill_marketplace_id, 'plugins', skill_marketplace_plugin_id]
        )
