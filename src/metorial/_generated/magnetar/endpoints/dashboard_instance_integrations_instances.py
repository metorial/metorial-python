...
class MetorialDashboardInstanceIntegrationsInstancesEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instances'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instances', integration_instance_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instances', integration_instance_id, 'session-template'],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instances', integration_instance_id, 'session'],
            body=body_dict
        )
