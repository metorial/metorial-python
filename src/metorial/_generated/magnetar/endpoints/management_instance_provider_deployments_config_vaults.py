...
class MetorialManagementInstanceProviderDeploymentsConfigVaultsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, provider_deployment_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceProviderDeploymentsConfigVaultsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-deployments', provider_deployment_id, 'config-vaults'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsConfigVaultsListOutput.from_dict)

    def get(self, instance_id: str, provider_deployment_id: str, provider_config_vault_id: str) -> DashboardInstanceProviderDeploymentsConfigVaultsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'provider-deployments', provider_deployment_id, 'config-vaults', provider_config_vault_id]
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsConfigVaultsGetOutput.from_dict)

    def create(self, instance_id: str, provider_deployment_id: str, *, name: str, data: Dict[str, Any], description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceProviderDeploymentsConfigVaultsCreateOutput:
        """
    ...
    def update(self, instance_id: str, provider_deployment_id: str, provider_config_vault_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceProviderDeploymentsConfigVaultsUpdateOutput:
        """
    ...
    def delete(self, instance_id: str, provider_deployment_id: str, provider_config_vault_id: str) -> DashboardInstanceProviderDeploymentsConfigVaultsDeleteOutput:
        """
