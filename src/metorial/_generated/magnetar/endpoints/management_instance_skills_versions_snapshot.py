...
class MetorialManagementInstanceSkillsVersionsSnapshotEndpoint(BaseMetorialEndpoint):
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'skills', skill_id, 'versions', skill_version_id, 'snapshot']
        )
