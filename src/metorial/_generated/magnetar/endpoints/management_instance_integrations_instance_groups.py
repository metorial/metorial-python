...
class MetorialManagementInstanceIntegrationsInstanceGroupsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-instance-groups'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-instance-groups', integration_instance_group_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-instance-groups', integration_instance_group_id, 'session-template'],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-instance-groups', integration_instance_group_id, 'session'],
            body=body_dict
        )
