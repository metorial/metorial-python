...
class MetorialProvidersToolsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, provider_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, provider_version_id: Optional[str] = None) -> DashboardInstanceProvidersToolsListOutput:
        """
    List provider tools
    ...
    """
        ...
        request = MetorialRequest(
            path=['providers', provider_id, 'tools'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProvidersToolsListOutput.from_dict)

    def get(self, provider_id: str, provider_tool_id: str) -> DashboardInstanceProvidersToolsGetOutput:
        """
    Get provider tool
    ...
    """
        request = MetorialRequest(
            path=['providers', provider_id, 'tools', provider_tool_id]
        )
