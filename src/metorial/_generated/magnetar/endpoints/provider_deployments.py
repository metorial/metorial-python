...
class MetorialProviderDeploymentsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, provider_id: Optional[Union[str, List[str]]] = None, provider_version_id: Optional[Union[str, List[str]]] = None, status: Optional[str] = None) -> DashboardInstanceProviderDeploymentsListOutput:
        """
    ...
    def create(self, *, name: str, provider_id: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, locked_provider_version_id: Optional[str] = None, config: Optional[Union[Dict[str, Any], Dict[str, Any], str]] = None) -> DashboardInstanceProviderDeploymentsCreateOutput:
        """
