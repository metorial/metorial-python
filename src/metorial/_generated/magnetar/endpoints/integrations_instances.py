...
class MetorialIntegrationsInstancesEndpoint(BaseMetorialEndpoint):
    """Integration instances materialize an integration for a specific actor, identity, or runtime configuration."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, integration_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, integration_provider_id: Optional[Union[str, List[str]]] = None, identity_id: Optional[Union[str, List[str]]] = None, identity_credential_id: Optional[Union[str, List[str]]] = None, identity_actor_id: Optional[Union[str, List[str]]] = None, provider_deployment_id: Optional[Union[str, List[str]]] = None, provider_config_id: Optional[Union[str, List[str]]] = None, provider_auth_config_id: Optional[Union[str, List[str]]] = None, session_template_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstancesListOutput:
        """
    ...
    def get(self, integration_instance_id: str) -> DashboardInstanceIntegrationsInstancesGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['integration-instances', integration_instance_id]
        )
        return self._get(request).transform(mapDashboardInstanceIntegrationsInstancesGetOutput.from_dict)

    def create_session_template(self, integration_instance_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstancesCreateSessionTemplateOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['integration-instances', integration_instance_id, 'session-template'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceIntegrationsInstancesCreateSessionTemplateOutput.from_dict)

    def create_session(self, integration_instance_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstancesCreateSessionOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['integration-instances', integration_instance_id, 'session'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceIntegrationsInstancesCreateSessionOutput.from_dict)

    def create(self, *, integration_id: str, name: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, identity_actor_id: Optional[str] = None, identity_id: Optional[str] = None, providers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceIntegrationsInstancesCreateOutput:
        """
    ...
    def update(self, integration_instance_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, identity_actor_id: Optional[str] = None, identity_id: Optional[str] = None, providers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceIntegrationsInstancesUpdateOutput:
        """
    ...
    def delete(self, integration_instance_id: str) -> DashboardInstanceIntegrationsInstancesDeleteOutput:
        """
