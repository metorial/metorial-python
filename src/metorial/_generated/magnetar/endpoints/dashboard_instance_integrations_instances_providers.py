...
class MetorialDashboardInstanceIntegrationsInstancesProvidersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instance-providers'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instance-providers', integration_instance_provider_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'integration-instances', integration_instance_id, 'providers', provider_id],
            body=body_dict
        )
