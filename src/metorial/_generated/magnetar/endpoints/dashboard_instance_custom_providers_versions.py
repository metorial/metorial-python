...
class MetorialDashboardInstanceCustomProvidersVersionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-providers', custom_provider_id, 'versions'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-providers', custom_provider_id, 'versions', custom_provider_version_id]
        )
