...
class MetorialManagementInstanceCustomProvidersCommitsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'custom-providers', custom_provider_id, 'commits'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'custom-providers', custom_provider_id, 'commits', custom_provider_commit_id]
        )
