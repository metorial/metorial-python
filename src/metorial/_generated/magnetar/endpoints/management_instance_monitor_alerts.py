...
class MetorialManagementInstanceMonitorAlertsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'monitor-alerts'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'monitor-alerts', monitor_alert_id]
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'monitor-alerts', monitor_alert_id, 'viewed']
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'monitor-alerts', monitor_alert_id, 'resolve']
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'monitor-alerts', monitor_alert_id, 'unresolve']
        )
