...
class MetorialMagicMcpServersEndpoint(BaseMetorialEndpoint):
    ...
    def get(self, magic_mcp_server_id: str) -> DashboardInstanceMagicMcpServersGetOutput:
        """
    ...
    def create(self, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, provider_template_id: Optional[str] = None, integration_instance_id: Optional[str] = None, consumer_profile_id: Optional[str] = None) -> DashboardInstanceMagicMcpServersCreateOutput:
        """
    ...
    def delete(self, magic_mcp_server_id: str) -> DashboardInstanceMagicMcpServersDeleteOutput:
        """
    ...
    def update(self, magic_mcp_server_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, aliases: Optional[List[str]] = None) -> DashboardInstanceMagicMcpServersUpdateOutput:
        """
