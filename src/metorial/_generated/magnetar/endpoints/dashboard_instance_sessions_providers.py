...
class MetorialDashboardInstanceSessionsProvidersEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'sessions', session_id, 'providers'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'sessions', session_id, 'providers', session_provider_id]
        )
