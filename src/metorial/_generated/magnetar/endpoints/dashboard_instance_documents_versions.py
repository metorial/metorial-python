...
class MetorialDashboardInstanceDocumentsVersionsEndpoint(BaseMetorialEndpoint):
    """Inspect document version history for an instance document."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, instance_id: str, document_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, last_edited_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceDocumentsVersionsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'documents', document_id, 'versions'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceDocumentsVersionsListOutput.from_dict)

    def get(self, instance_id: str, document_id: str, document_version_id: str) -> DashboardInstanceDocumentsVersionsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'documents', document_id, 'versions', document_version_id]
        )
