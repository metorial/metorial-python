...
class MetorialDashboardInstanceCustomProvidersDeploymentsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, custom_provider_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, ids: Optional[Union[str, List[str]]] = None, custom_provider_version_ids: Optional[Union[str, List[str]]] = None) -> DashboardInstanceCustomProvidersDeploymentsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-providers', custom_provider_id, 'deployments'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceCustomProvidersDeploymentsListOutput.from_dict)

    def get(self, instance_id: str, custom_provider_id: str, custom_provider_deployment_id: str) -> DashboardInstanceCustomProvidersDeploymentsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-providers', custom_provider_id, 'deployments', custom_provider_deployment_id]
        )
        return self._get(request).transform(mapDashboardInstanceCustomProvidersDeploymentsGetOutput.from_dict)

    def get_logs(self, instance_id: str, custom_provider_id: str, custom_provider_deployment_id: str) -> DashboardInstanceCustomProvidersDeploymentsGetLogsOutput:
        """
    Get deployment logs
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'custom-providers', custom_provider_id, 'deployments', custom_provider_deployment_id, 'logs']
        )
