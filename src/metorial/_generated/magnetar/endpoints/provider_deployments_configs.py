...
class MetorialProviderDeploymentsConfigsEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, provider_deployment_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceProviderDeploymentsConfigsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'configs'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsConfigsListOutput.from_dict)

    def get(self, provider_deployment_id: str, provider_config_id: str) -> DashboardInstanceProviderDeploymentsConfigsGetOutput:
        """
    Get provider config
    ...
    """
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'configs', provider_config_id]
        )
        return self._get(request).transform(mapDashboardInstanceProviderDeploymentsConfigsGetOutput.from_dict)

    def create(self, provider_deployment_id: str, *, name: str, config: Union[Dict[str, Any], Dict[str, Any]], description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceProviderDeploymentsConfigsCreateOutput:
        """
    ...
    def update(self, provider_deployment_id: str, provider_config_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceProviderDeploymentsConfigsUpdateOutput:
        """
    ...
    def delete(self, provider_deployment_id: str, provider_config_id: str) -> DashboardInstanceProviderDeploymentsConfigsDeleteOutput:
        """
    ...
    def get_config_schema(self, provider_deployment_id: str) -> DashboardInstanceProviderDeploymentsConfigsGetConfigSchemaOutput:
        """
    Get config schema
    ...
    """
        request = MetorialRequest(
            path=['provider-deployments', provider_deployment_id, 'config-schema']
        )
