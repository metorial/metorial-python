...
class MetorialScmReposEndpoint(BaseMetorialEndpoint):
    ...
    def create(self, *, installation_id: str, external_repo_id: Optional[str] = None, external_account_id: Optional[str] = None, name: Optional[str] = None, is_private: Optional[bool] = None) -> DashboardInstanceScmReposCreateOutput:
        """
    Create SCM repo
