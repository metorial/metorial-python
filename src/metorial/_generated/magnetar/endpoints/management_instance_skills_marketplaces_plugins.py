...
class MetorialManagementInstanceSkillsMarketplacesPluginsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'skill-marketplaces', skill_marketplace_id, 'plugins'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'skill-marketplaces', skill_marketplace_id, 'plugins', skill_marketplace_plugin_id]
        )
