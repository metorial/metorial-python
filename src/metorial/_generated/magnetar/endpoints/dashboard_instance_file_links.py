...
class MetorialDashboardInstanceFileLinksEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, instance_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, file_id: Optional[str] = None) -> DashboardInstanceFileLinksListOutput:
        """
    List file links
    ...
    def get(self, instance_id: str, link_id: str) -> DashboardInstanceFileLinksGetOutput:
        """
    Get file link by ID
    ...
    def create(self, instance_id: str, *, file_id: str, expires_at: Optional[datetime] = None) -> DashboardInstanceFileLinksCreateOutput:
        """
    Create file link
    ...
    def delete(self, instance_id: str, link_id: str) -> DashboardInstanceFileLinksDeleteOutput:
        """
