...
class MetorialCallbacksDestinationsEndpoint(BaseMetorialEndpoint):
    """Manage callback webhook destinations."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, callback_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceCallbacksDestinationsListOutput:
        """
    ...
    def get(self, callback_destination_id: str) -> DashboardInstanceCallbacksDestinationsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['callback-destinations', callback_destination_id]
        )
        return self._get(request).transform(mapDashboardInstanceCallbacksDestinationsGetOutput.from_dict)

    def create(self, *, name: str, url: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceCallbacksDestinationsCreateOutput:
        """
    ...
    def update(self, callback_destination_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, url: Optional[str] = None) -> DashboardInstanceCallbacksDestinationsUpdateOutput:
        """
    ...
    def delete(self, callback_destination_id: str) -> DashboardInstanceCallbacksDestinationsDeleteOutput:
        """
