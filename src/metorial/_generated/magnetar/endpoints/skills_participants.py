...
class MetorialSkillsParticipantsEndpoint(BaseMetorialEndpoint):
    """Inspect participants associated with an instance skill."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, skill_id: str, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None) -> DashboardInstanceSkillsParticipantsListOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['skills', skill_id, 'participants'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSkillsParticipantsListOutput.from_dict)

    def get(self, skill_id: str, skill_participant_id: str) -> DashboardInstanceSkillsParticipantsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['skills', skill_id, 'participants', skill_participant_id]
        )
