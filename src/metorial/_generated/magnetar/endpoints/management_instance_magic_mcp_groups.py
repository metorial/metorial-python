...
class MetorialManagementInstanceMagicMcpGroupsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-groups'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-groups', magic_mcp_group_id]
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-groups', magic_mcp_group_id, 'add-servers'],
            body=body_dict
        )
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'magic-mcp-groups', magic_mcp_group_id, 'remove-servers'],
            body=body_dict
        )
