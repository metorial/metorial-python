...
class MetorialManagementInstanceCustomProvidersDeploymentsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'custom-providers', custom_provider_id, 'deployments'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'custom-providers', custom_provider_id, 'deployments', custom_provider_deployment_id]
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'custom-providers', custom_provider_id, 'deployments', custom_provider_deployment_id, 'logs']
        )
