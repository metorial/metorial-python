...
class MetorialDashboardInstancePortalsAuthSsoTenantsConnectionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'portals', portal_id, 'auth', 'sso-tenants', sso_tenant_id, 'connections'],
            query=query_dict
        )
