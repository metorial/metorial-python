...
class MetorialSkillsGroupsItemsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['skill-groups', skill_group_id, 'items'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceSkillsGroupsItemsListOutput.from_dict)

    def get(self, skill_group_id: str, skill_group_item_id: str) -> DashboardInstanceSkillsGroupsItemsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['skill-groups', skill_group_id, 'items', skill_group_item_id]
        )
        return self._get(request).transform(mapDashboardInstanceSkillsGroupsItemsGetOutput.from_dict)

    def create(self, skill_group_id: str, *, skill_id: str) -> DashboardInstanceSkillsGroupsItemsCreateOutput:
        """
    ...
    def delete(self, skill_group_id: str, skill_group_item_id: str) -> DashboardInstanceSkillsGroupsItemsDeleteOutput:
        """
