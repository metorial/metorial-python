...
class MetorialManagementInstanceIntegrationsSetupSessionsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-setup-sessions'],
            query=query_dict
        )
    ...
    """
        request = MetorialRequest(
            path=['instances', instance_id, 'integration-setup-sessions', integration_setup_session_id]
        )
