...
class MetorialDashboardInstanceDocumentsParticipantsEndpoint(BaseMetorialEndpoint):
    ...
    """
        ...
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'documents', document_id, 'participants'],
            query=query_dict
        )
        return self._get(request).transform(mapDashboardInstanceDocumentsParticipantsListOutput.from_dict)

    def get(self, instance_id: str, document_id: str, document_participant_id: str) -> DashboardInstanceDocumentsParticipantsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['dashboard', 'instances', instance_id, 'documents', document_id, 'participants', document_participant_id]
        )
