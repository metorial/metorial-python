...
class MetorialManagementOrganizationApiKeysEndpoint(BaseMetorialEndpoint):
    ...
    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, type: Any = None, instance_id: str = None) -> DashboardOrganizationsApiKeysListOutput:
        """
    Get user
    ...
    def get(self, api_key_id: str) -> DashboardOrganizationsApiKeysGetOutput:
        """
    Get API key
    ...
    def create(self, *, name: str, type: Any = None, instance_id: str = None, description: Optional[str] = None, expires_at: Optional[datetime] = None, ip_filters: Optional[List[str]] = None) -> DashboardOrganizationsApiKeysCreateOutput:
        """
    Create API key
    ...
    def update(self, api_key_id: str, *, name: Optional[str] = None, description: Optional[str] = None, expires_at: Optional[datetime] = None, ip_filters: Optional[List[str]] = None) -> DashboardOrganizationsApiKeysUpdateOutput:
        """
    Update API key
    ...
    def revoke(self, api_key_id: str) -> DashboardOrganizationsApiKeysRevokeOutput:
        """
    Revoke API key
