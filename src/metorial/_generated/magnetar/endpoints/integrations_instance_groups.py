...
class MetorialIntegrationsInstanceGroupsEndpoint(BaseMetorialEndpoint):
    """Integration instance groups combine instance providers into a grouped routed configuration."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, status: Optional[Union[str, List[str]]] = None, id: Optional[Union[str, List[str]]] = None, integration_id: Optional[Union[str, List[str]]] = None, integration_instance_id: Optional[Union[str, List[str]]] = None, integration_instance_provider_id: Optional[Union[str, List[str]]] = None, provider_id: Optional[Union[str, List[str]]] = None, integration_provider_id: Optional[Union[str, List[str]]] = None, provider_deployment_id: Optional[Union[str, List[str]]] = None, provider_config_id: Optional[Union[str, List[str]]] = None, provider_auth_config_id: Optional[Union[str, List[str]]] = None, session_template_id: Optional[Union[str, List[str]]] = None, created_at: Optional[Dict[str, Any]] = None, updated_at: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstanceGroupsListOutput:
        """
    ...
    def get(self, integration_instance_group_id: str) -> DashboardInstanceIntegrationsInstanceGroupsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['integration-instance-groups', integration_instance_group_id]
        )
        return self._get(request).transform(mapDashboardInstanceIntegrationsInstanceGroupsGetOutput.from_dict)

    def create_session_template(self, integration_instance_group_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['integration-instance-groups', integration_instance_group_id, 'session-template'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceIntegrationsInstanceGroupsCreateSessionTemplateOutput.from_dict)

    def create_session(self, integration_instance_group_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> DashboardInstanceIntegrationsInstanceGroupsCreateSessionOutput:
        """
    ...
    """
        ...
        request = MetorialRequest(
            path=['integration-instance-groups', integration_instance_group_id, 'session'],
            body=body_dict
        )
        return self._post(request).transform(mapDashboardInstanceIntegrationsInstanceGroupsCreateSessionOutput.from_dict)

    def create(self, *, name: str, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, providers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceIntegrationsInstanceGroupsCreateOutput:
        """
    ...
    def update(self, integration_instance_group_id: str, *, name: Optional[str] = None, description: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None, providers: Optional[List[Dict[str, Any]]] = None) -> DashboardInstanceIntegrationsInstanceGroupsUpdateOutput:
        """
    ...
    def delete(self, integration_instance_group_id: str) -> DashboardInstanceIntegrationsInstanceGroupsDeleteOutput:
        """
