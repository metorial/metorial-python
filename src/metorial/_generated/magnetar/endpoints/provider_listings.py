...
class MetorialProviderListingsEndpoint(BaseMetorialEndpoint):
    """A listing is a provider enriched with marketplace metadata."""

    def __init__(self, config: MetorialEndpointManager):
        super().__init__(config)

    def list(self, *, limit: Optional[float] = None, after: Optional[str] = None, before: Optional[str] = None, cursor: Optional[str] = None, order: Optional[str] = None, search: Optional[str] = None, provider_id: Optional[Union[str, List[str]]] = None, provider_version_id: Optional[str] = None, provider_category_id: Optional[Union[str, List[str]]] = None, provider_collection_id: Optional[Union[str, List[str]]] = None, provider_group_id: Optional[Union[str, List[str]]] = None, publisher_id: Optional[Union[str, List[str]]] = None, flags: Optional[Dict[str, Any]] = None) -> DashboardInstanceProviderListingsListOutput:
        """
    ...
    def get(self, provider_listing_id: str) -> DashboardInstanceProviderListingsGetOutput:
        """
    ...
    """
        request = MetorialRequest(
            path=['provider-listings', provider_listing_id]
        )
