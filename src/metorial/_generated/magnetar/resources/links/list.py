...
class mapLinksListOutputItemsPurpose:
    ...
    @staticmethod
    def to_dict(value: Union[LinksListOutputItemsPurpose, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapLinksListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> LinksListOutputItems:
        ...
        purpose=mapLinksListOutputItemsPurpose.from_dict(data.get('purpose')) if data.get('purpose') else None,
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None
        )

    @staticmethod
    def to_dict(value: Union[LinksListOutputItems, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapLinksListOutputPagination:
    ...
    @staticmethod
    def to_dict(value: Union[LinksListOutputPagination, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapLinksListOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> LinksListOutput:
        ...
        items=[mapLinksListOutputItems.from_dict(item) for item in data.get('items', []) if item],
        pagination=mapLinksListOutputPagination.from_dict(data.get('pagination')) if data.get('pagination') else None
        )

    @staticmethod
    def to_dict(value: Union[LinksListOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
