...
class mapSessionsMessagesListOutputItemsSender:
    ...
    @staticmethod
    def to_dict(value: Union[SessionsMessagesListOutputItemsSender, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapSessionsMessagesListOutputItemsMcpMessage:
    ...
    @staticmethod
    def to_dict(value: Union[SessionsMessagesListOutputItemsMcpMessage, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapSessionsMessagesListOutputItems:
    ...
    def from_dict(data: Dict[str, Any]) -> SessionsMessagesListOutputItems:
        ...
        id=data.get('id'),
        type=data.get('type'),
        sender=mapSessionsMessagesListOutputItemsSender.from_dict(data.get('sender')) if data.get('sender') else None,
        mcp_message=mapSessionsMessagesListOutputItemsMcpMessage.from_dict(data.get('mcp_message')) if data.get('mcp_message') else None,
