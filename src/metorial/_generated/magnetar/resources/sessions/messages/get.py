...
class mapSessionsMessagesGetOutputSender:
    ...
    @staticmethod
    def to_dict(value: Union[SessionsMessagesGetOutputSender, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
...
class mapSessionsMessagesGetOutputMcpMessage:
    ...
    @staticmethod
    def to_dict(value: Union[SessionsMessagesGetOutputMcpMessage, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapSessionsMessagesGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> SessionsMessagesGetOutput:
        ...
        id=data.get('id'),
        type=data.get('type'),
        sender=mapSessionsMessagesGetOutputSender.from_dict(data.get('sender')) if data.get('sender') else None,
        mcp_message=mapSessionsMessagesGetOutputMcpMessage.from_dict(data.get('mcp_message')) if data.get('mcp_message') else None,
