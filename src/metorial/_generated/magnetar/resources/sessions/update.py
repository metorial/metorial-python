...
@dataclass
class SessionsUpdateOutputProviderDeployments:
    object: str
    id: str
    provider_id: str
...
class SessionsUpdateOutput:
    ...
    provider_deployments: List[SessionsUpdateOutputProviderDeployments]
    created_at: datetime
    updated_at: datetime
    name: Optional[str] = None
...
class mapSessionsUpdateOutputProviderDeployments:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> SessionsUpdateOutputProviderDeployments:
        return SessionsUpdateOutputProviderDeployments(
    ...
    @staticmethod
    def to_dict(value: Union[SessionsUpdateOutputProviderDeployments, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapSessionsUpdateOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> SessionsUpdateOutput:
        ...
        provider_deployments=[mapSessionsUpdateOutputProviderDeployments.from_dict(item) for item in data.get('provider_deployments', []) if item],
