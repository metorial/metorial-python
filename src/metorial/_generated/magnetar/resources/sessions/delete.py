...
@dataclass
class SessionsDeleteOutputProviderDeployments:
    object: str
    id: str
    provider_id: str
...
class SessionsDeleteOutput:
    ...
    provider_deployments: List[SessionsDeleteOutputProviderDeployments]
    created_at: datetime
    updated_at: datetime
    name: Optional[str] = None
...
class mapSessionsDeleteOutputProviderDeployments:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> SessionsDeleteOutputProviderDeployments:
        return SessionsDeleteOutputProviderDeployments(
    ...
    @staticmethod
    def to_dict(value: Union[SessionsDeleteOutputProviderDeployments, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapSessionsDeleteOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> SessionsDeleteOutput:
        ...
        provider_deployments=[mapSessionsDeleteOutputProviderDeployments.from_dict(item) for item in data.get('provider_deployments', []) if item],
