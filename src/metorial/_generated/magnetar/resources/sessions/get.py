...
@dataclass
class SessionsGetOutputProviderDeployments:
    object: str
    id: str
    provider_id: str
...
class SessionsGetOutput:
    ...
    provider_deployments: List[SessionsGetOutputProviderDeployments]
    created_at: datetime
    updated_at: datetime
    name: Optional[str] = None
...
class mapSessionsGetOutputProviderDeployments:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> SessionsGetOutputProviderDeployments:
        return SessionsGetOutputProviderDeployments(
    ...
    @staticmethod
    def to_dict(value: Union[SessionsGetOutputProviderDeployments, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapSessionsGetOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> SessionsGetOutput:
        ...
        provider_deployments=[mapSessionsGetOutputProviderDeployments.from_dict(item) for item in data.get('provider_deployments', []) if item],
