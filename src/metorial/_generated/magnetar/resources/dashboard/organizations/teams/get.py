...
class mapDashboardOrganizationsTeamsGetOutputProjectsRolesRole:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsTeamsGetOutputProjectsRolesRole:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsTeamsGetOutputProjectsRolesRole, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsTeamsGetOutputProjectsRoles:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsTeamsGetOutputProjectsRoles:
        return DashboardOrganizationsTeamsGetOutputProjectsRoles(
        id=data.get('id'),
        role=mapDashboardOrganizationsTeamsGetOutputProjectsRolesRole.from_dict(data.get('role')) if data.get('role') else None,
        created_at=datetime.fromisoformat(data.get('created_at')) if data.get('created_at') else None,
        updated_at=datetime.fromisoformat(data.get('updated_at')) if data.get('updated_at') else None
        )

    @staticmethod
    def to_dict(value: Union[DashboardOrganizationsTeamsGetOutputProjectsRoles, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardOrganizationsTeamsGetOutputProjects:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardOrganizationsTeamsGetOutputProjects:
        ...
        roles=[mapDashboardOrganizationsTeamsGetOutputProjectsRoles.from_dict(item) for item in data.get('roles', []) if item]
        )
