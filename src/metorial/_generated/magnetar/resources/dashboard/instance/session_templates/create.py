...
@dataclass
class DashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters:
...
class DashboardInstanceSessionTemplatesCreateBodyProviders:
    ...
    tool_filters: Optional[DashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters] = None
@dataclass
...
class mapDashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters:
        return DashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters(
        tool_keys=data.get('tool_keys', [])
        )

    @staticmethod
    def to_dict(value: Union[DashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardInstanceSessionTemplatesCreateBodyProviders:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceSessionTemplatesCreateBodyProviders:
        ...
        tool_filters=mapDashboardInstanceSessionTemplatesCreateBodyProvidersToolFilters.from_dict(data.get('tool_filters')) if data.get('tool_filters') else None
        )
