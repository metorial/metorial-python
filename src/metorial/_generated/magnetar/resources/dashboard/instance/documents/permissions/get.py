...
@dataclass
class DashboardInstanceDocumentsPermissionsGetOutput:
    object: str
    document_id: str
    is_owner: bool
...
class mapDashboardInstanceDocumentsPermissionsGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceDocumentsPermissionsGetOutput:
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceDocumentsPermissionsGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
