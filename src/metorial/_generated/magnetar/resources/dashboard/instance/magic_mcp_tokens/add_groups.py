...
@dataclass
class DashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint:
    object: str
    id: str
    status: str
    slug: str
...
class DashboardInstanceMagicMcpTokensAddGroupsOutput:
    ...
    endpoint: Optional[DashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint] = None
...
class mapDashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint:
        return DashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint(
        object=data.get('object'),
        id=data.get('id'),
        status=data.get('status'),
        slug=data.get('slug'),
    ...
    @staticmethod
    def to_dict(value: Union[DashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
        if isinstance(value, dict):
            return value
...
class mapDashboardInstanceMagicMcpTokensAddGroupsOutput:
    ...
    def from_dict(data: Dict[str, Any]) -> DashboardInstanceMagicMcpTokensAddGroupsOutput:
        ...
        endpoint=mapDashboardInstanceMagicMcpTokensAddGroupsOutputEndpoint.from_dict(data.get('endpoint')) if data.get('endpoint') else None,
