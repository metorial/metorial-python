...
@dataclass
class IntegrationsInstanceGroupsProvidersGetOutput:
    object: str
    id: str
    status: str
    name: str
...
class mapIntegrationsInstanceGroupsProvidersGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> IntegrationsInstanceGroupsProvidersGetOutput:
        return IntegrationsInstanceGroupsProvidersGetOutput(
    ...
    @staticmethod
    def to_dict(value: Union[IntegrationsInstanceGroupsProvidersGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
