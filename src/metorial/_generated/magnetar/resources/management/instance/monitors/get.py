...
@dataclass
class ManagementInstanceMonitorsGetOutput:
    object: str
    id: str
    name: str
    target: str
...
class mapManagementInstanceMonitorsGetOutput:
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> ManagementInstanceMonitorsGetOutput:
        return ManagementInstanceMonitorsGetOutput(
    ...
    @staticmethod
    def to_dict(value: Union[ManagementInstanceMonitorsGetOutput, Dict[str, Any], None]) -> Optional[Dict[str, Any]]:
        if value is None:
            return None
