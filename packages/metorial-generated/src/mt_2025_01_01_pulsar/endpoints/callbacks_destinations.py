...
class MetorialCallbacksDestinationsEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(path=["callbacks-destinations"], query=query_dict)
    return self._get(request).transform(
      mapDashboardInstanceCallbacksDestinationsListOutput.from_dict
    )

  def get(self, destination_id: str) -> DashboardInstanceCallbacksDestinationsGetOutput:
    """
    ...
    """
    request = MetorialRequest(path=["callbacks-destinations", destination_id])
    return self._get(request).transform(
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(path=["callbacks-destinations"], body=body_dict)
  ...
  def update(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["callbacks-destinations", destination_id], body=body_dict
    )
