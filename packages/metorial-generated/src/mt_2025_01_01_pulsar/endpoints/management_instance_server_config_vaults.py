...
class MetorialManagementInstanceServerConfigVaultsEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["instances", instance_id, "server-config-vault"], query=query_dict
    )
  ...
  def get(
    ...
    """
    request = MetorialRequest(
      path=["instances", instance_id, "server-config-vault", server_config_vault_id]
    )
    return self._get(request).transform(
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["instances", instance_id, "server-config-vault"], body=body_dict
    )
