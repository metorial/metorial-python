...
class mapDashboardInstanceSessionsGetOutputClientSecret:
  ...
  @staticmethod
  def to_dict(
    value: Union[DashboardInstanceSessionsGetOutputClientSecret, Dict[str, Any], None]
...
class mapDashboardInstanceSessionsGetOutputServerDeploymentsServer:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceSessionsGetOutputServerDeploymentsServer:
  ...
  def to_dict(
    value: Union[
      DashboardInstanceSessionsGetOutputServerDeploymentsServer, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceSessionsGetOutputServerDeploymentsConnectionUrls:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceSessionsGetOutputServerDeploymentsConnectionUrls:
...
class mapDashboardInstanceSessionsGetOutputServerDeployments:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceSessionsGetOutputServerDeployments:
    return DashboardInstanceSessionsGetOutputServerDeployments(
      ...
      server=mapDashboardInstanceSessionsGetOutputServerDeploymentsServer.from_dict(
        data.get("server")
      )
      if data.get("server")
      else None,
      connection_urls=mapDashboardInstanceSessionsGetOutputServerDeploymentsConnectionUrls.from_dict(
  ...
  def to_dict(
    value: Union[
      DashboardInstanceSessionsGetOutputServerDeployments, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceSessionsGetOutputUsage:
  ...
  @staticmethod
  def to_dict(
    value: Union[DashboardInstanceSessionsGetOutputUsage, Dict[str, Any], None]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
    if isinstance(value, dict):
