...
@dataclass
class DashboardInstanceServersDeploymentsDeleteOutputCallbackSchedule:
  object: str
...
@dataclass
class DashboardInstanceServersDeploymentsDeleteOutputCallback:
  object: str
  id: str
  type: str
  schedule: DashboardInstanceServersDeploymentsDeleteOutputCallbackSchedule
  created_at: datetime
  updated_at: datetime
...
@dataclass
class DashboardInstanceServersDeploymentsDeleteOutputAccess:
...
class DashboardInstanceServersDeploymentsDeleteOutput:
  ...
  oauth_connection: Optional[
    DashboardInstanceServersDeploymentsDeleteOutputOauthConnection
  ] = None
  callback: Optional[DashboardInstanceServersDeploymentsDeleteOutputCallback] = None
  access: Optional[DashboardInstanceServersDeploymentsDeleteOutputAccess] = None
...
class mapDashboardInstanceServersDeploymentsDeleteOutputOauthConnectionProvider:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputOauthConnectionProvider:
...
class mapDashboardInstanceServersDeploymentsDeleteOutputOauthConnection:
  ...
  def from_dict(
    ...
    return DashboardInstanceServersDeploymentsDeleteOutputOauthConnection(
      ...
      provider=mapDashboardInstanceServersDeploymentsDeleteOutputOauthConnectionProvider.from_dict(
        data.get("provider")
      )
...
class mapDashboardInstanceServersDeploymentsDeleteOutputCallbackSchedule:
  @staticmethod
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputCallbackSchedule:
...
class mapDashboardInstanceServersDeploymentsDeleteOutputCallback:
  @staticmethod
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputCallback:
    return DashboardInstanceServersDeploymentsDeleteOutputCallback(
      object=data.get("object"),
      id=data.get("id"),
      url=data.get("url"),
      name=data.get("name"),
      description=data.get("description"),
      type=data.get("type"),
      schedule=mapDashboardInstanceServersDeploymentsDeleteOutputCallbackSchedule.from_dict(
        data.get("schedule")
      )
  ...
  def to_dict(
    value: Union[
      DashboardInstanceServersDeploymentsDeleteOutputCallback, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceServersDeploymentsDeleteOutputServer:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputServer:
  ...
  def to_dict(
    value: Union[
      DashboardInstanceServersDeploymentsDeleteOutputServer, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceServersDeploymentsDeleteOutputConfig:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputConfig:
  ...
  def to_dict(
    value: Union[
      DashboardInstanceServersDeploymentsDeleteOutputConfig, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceServersDeploymentsDeleteOutputServerImplementationServerVariant:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputServerImplementationServerVariant:
    return (
      DashboardInstanceServersDeploymentsDeleteOutputServerImplementationServerVariant(
        object=data.get("object"),
        id=data.get("id"),
...
class mapDashboardInstanceServersDeploymentsDeleteOutputServerImplementationServer:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputServerImplementationServer:
...
class mapDashboardInstanceServersDeploymentsDeleteOutputServerImplementation:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputServerImplementation:
    return DashboardInstanceServersDeploymentsDeleteOutputServerImplementation(
      ...
      server_variant=mapDashboardInstanceServersDeploymentsDeleteOutputServerImplementationServerVariant.from_dict(
        data.get("server_variant")
      )
      if data.get("server_variant")
      else None,
      server=mapDashboardInstanceServersDeploymentsDeleteOutputServerImplementationServer.from_dict(
        data.get("server")
      )
      if data.get("server")
      else None,
...
class mapDashboardInstanceServersDeploymentsDeleteOutputAccess:
  @staticmethod
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceServersDeploymentsDeleteOutputAccess:
  ...
  def to_dict(
    value: Union[
      DashboardInstanceServersDeploymentsDeleteOutputAccess, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceServersDeploymentsDeleteOutput:
  ...
  def from_dict(
    ...
    return DashboardInstanceServersDeploymentsDeleteOutput(
      ...
      name=data.get("name"),
      description=data.get("description"),
      oauth_connection=mapDashboardInstanceServersDeploymentsDeleteOutputOauthConnection.from_dict(
        data.get("oauth_connection")
      )
      if data.get("oauth_connection")
      else None,
      callback=mapDashboardInstanceServersDeploymentsDeleteOutputCallback.from_dict(
        data.get("callback")
      )
      ...
      metadata=data.get("metadata"),
      secret_id=data.get("secret_id"),
      server=mapDashboardInstanceServersDeploymentsDeleteOutputServer.from_dict(
        data.get("server")
      )
      if data.get("server")
      else None,
      config=mapDashboardInstanceServersDeploymentsDeleteOutputConfig.from_dict(
        data.get("config")
      )
      if data.get("config")
      else None,
      server_implementation=mapDashboardInstanceServersDeploymentsDeleteOutputServerImplementation.from_dict(
        data.get("server_implementation")
      )
      if data.get("server_implementation")
      else None,
      access=mapDashboardInstanceServersDeploymentsDeleteOutputAccess.from_dict(
        data.get("access")
      )
      if data.get("access")
      else None,
  ...
  @staticmethod
  def to_dict(
    value: Union[DashboardInstanceServersDeploymentsDeleteOutput, Dict[str, Any], None]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
    if isinstance(value, dict):
