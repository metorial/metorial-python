...
class mapManagementInstanceInstanceGetOutputProject:
  ...
  @staticmethod
  def to_dict(
    value: Union[ManagementInstanceInstanceGetOutputProject, Dict[str, Any], None]
...
class mapManagementInstanceInstanceGetOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> ManagementInstanceInstanceGetOutput:
    return ManagementInstanceInstanceGetOutput(
      ...
      type=data.get("type"),
      organization_id=data.get("organization_id"),
      project=mapManagementInstanceInstanceGetOutputProject.from_dict(
        data.get("project")
      )
      if data.get("project")
      else None,
  ...
  @staticmethod
  def to_dict(
    value: Union[ManagementInstanceInstanceGetOutput, Dict[str, Any], None]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
    if isinstance(value, dict):
