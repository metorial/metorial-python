...
class mapManagementInstanceMagicMcpSessionsGetOutputMagicMcpServer:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceMagicMcpSessionsGetOutputMagicMcpServer:
  ...
  def to_dict(
    value: Union[
      ManagementInstanceMagicMcpSessionsGetOutputMagicMcpServer, Dict[str, Any], None
    ]
...
class mapManagementInstanceMagicMcpSessionsGetOutputUsage:
  @staticmethod
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceMagicMcpSessionsGetOutputUsage:
    return ManagementInstanceMagicMcpSessionsGetOutputUsage(
  ...
  @staticmethod
  def to_dict(
    value: Union[ManagementInstanceMagicMcpSessionsGetOutputUsage, Dict[str, Any], None]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
    if isinstance(value, dict):
