...
class mapDashboardOrganizationsInvitesDeleteOutputInvitedByTeams:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardOrganizationsInvitesDeleteOutputInvitedByTeams:
  ...
  def to_dict(
    value: Union[
      DashboardOrganizationsInvitesDeleteOutputInvitedByTeams, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardOrganizationsInvitesDeleteOutputInvitedBy:
  ...
  def from_dict(
    ...
    return DashboardOrganizationsInvitesDeleteOutputInvitedBy(
      ...
      image_url=data.get("image_url"),
      teams=[
        mapDashboardOrganizationsInvitesDeleteOutputInvitedByTeams.from_dict(item)
