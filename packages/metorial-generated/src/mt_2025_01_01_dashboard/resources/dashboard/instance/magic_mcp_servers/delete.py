...
@dataclass
class DashboardInstanceMagicMcpServersDeleteOutputDefaultOauthSession:
  object: str
  id: str
  status: str
  metadata: Dict[str, Any]
...
class DashboardInstanceMagicMcpServersDeleteOutput:
  ...
  default_oauth_session: Optional[
    DashboardInstanceMagicMcpServersDeleteOutputDefaultOauthSession
  ] = None
...
class mapDashboardInstanceMagicMcpServersDeleteOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> DashboardInstanceMagicMcpServersDeleteOutput:
    return DashboardInstanceMagicMcpServersDeleteOutput(
      ...
      default_oauth_session=mapDashboardInstanceMagicMcpServersDeleteOutputDefaultOauthSession.from_dict(
