...
@dataclass
class DashboardInstanceProviderOauthConnectionsProfilesGetOutput:
  object: str
  id: str
  status: str
  sub: str
...
class mapDashboardInstanceProviderOauthConnectionsProfilesGetOutput:
  @staticmethod
  def from_dict(
    data: Dict[str, Any]
  ...
  def to_dict(
    value: Union[
      DashboardInstanceProviderOauthConnectionsProfilesGetOutput, Dict[str, Any], None
    ]
