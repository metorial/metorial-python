...
@dataclass
class DashboardInstanceCustomServersGetOutputRepository:
  object: str
  id: str
  name: str
  owner: str
...
class DashboardInstanceCustomServersGetOutput:
  ...
  repository: Optional[DashboardInstanceCustomServersGetOutputRepository] = None
...
class mapDashboardInstanceCustomServersGetOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> DashboardInstanceCustomServersGetOutput:
    return DashboardInstanceCustomServersGetOutput(
      ...
      server=mapDashboardInstanceCustomServersGetOutputServer.from_dict(
        data.get("server")
      )
      if data.get("server")
      else None,
      server_variant=mapDashboardInstanceCustomServersGetOutputServerVariant.from_dict(
      ...
      fork=data.get("fork"),
      repository=mapDashboardInstanceCustomServersGetOutputRepository.from_dict(
        data.get("repository")
      )
  ...
  @staticmethod
  def to_dict(
    value: Union[DashboardInstanceCustomServersGetOutput, Dict[str, Any], None]
