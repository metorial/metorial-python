...
@dataclass
class DashboardInstanceCustomServersDeleteOutputRepository:
  object: str
  id: str
  name: str
  owner: str
...
class DashboardInstanceCustomServersDeleteOutput:
  ...
  repository: Optional[DashboardInstanceCustomServersDeleteOutputRepository] = None
...
class mapDashboardInstanceCustomServersDeleteOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> DashboardInstanceCustomServersDeleteOutput:
    return DashboardInstanceCustomServersDeleteOutput(
      ...
      server=mapDashboardInstanceCustomServersDeleteOutputServer.from_dict(
        data.get("server")
      )
      if data.get("server")
      else None,
      server_variant=mapDashboardInstanceCustomServersDeleteOutputServerVariant.from_dict(
      ...
      fork=data.get("fork"),
      repository=mapDashboardInstanceCustomServersDeleteOutputRepository.from_dict(
        data.get("repository")
      )
  ...
  @staticmethod
  def to_dict(
    value: Union[DashboardInstanceCustomServersDeleteOutput, Dict[str, Any], None]
