...
@dataclass
class DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActorTeams:
  id: str
  name: str
  slug: str
  assignment_id: str
...
class DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActor:
  ...
  name: str
  image_url: str
  teams: List[DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActorTeams]
  created_at: datetime
  updated_at: datetime
...
class mapDashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActorTeams:
  @staticmethod
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActorTeams:
    return DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActorTeams(
      id=data.get("id"),
      name=data.get("name"),
      slug=data.get("slug"),
...
class mapDashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActor:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActor:
    return DashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActor(
      ...
      teams=[
        mapDashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActorTeams.from_dict(
          item
        )
...
class mapDashboardInstanceCustomServersDeploymentsListOutputItemsStepsLogs:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceCustomServersDeploymentsListOutputItemsStepsLogs:
...
class mapDashboardInstanceCustomServersDeploymentsListOutputItemsSteps:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceCustomServersDeploymentsListOutputItemsSteps:
    return DashboardInstanceCustomServersDeploymentsListOutputItemsSteps(
      ...
      type=data.get("type"),
      logs=[
        mapDashboardInstanceCustomServersDeploymentsListOutputItemsStepsLogs.from_dict(
          item
        )
...
class mapDashboardInstanceCustomServersDeploymentsListOutputItems:
  ...
  def from_dict(
    ...
    return DashboardInstanceCustomServersDeploymentsListOutputItems(
      ...
      creator_actor=mapDashboardInstanceCustomServersDeploymentsListOutputItemsCreatorActor.from_dict(
      ...
      steps=[
        mapDashboardInstanceCustomServersDeploymentsListOutputItemsSteps.from_dict(item)
  ...
  def to_dict(
    value: Union[
      DashboardInstanceCustomServersDeploymentsListOutputItems, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceCustomServersDeploymentsListOutputPagination:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> DashboardInstanceCustomServersDeploymentsListOutputPagination:
...
class mapDashboardInstanceCustomServersDeploymentsListOutput:
  ...
  def from_dict(
    ...
    return DashboardInstanceCustomServersDeploymentsListOutput(
      items=[
        mapDashboardInstanceCustomServersDeploymentsListOutputItems.from_dict(item)
        for item in data.get("items", [])
        if item
      ],
      pagination=mapDashboardInstanceCustomServersDeploymentsListOutputPagination.from_dict(
        data.get("pagination")
      )
  ...
  def to_dict(
    value: Union[
      DashboardInstanceCustomServersDeploymentsListOutput, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapDashboardInstanceCustomServersDeploymentsListQuery:
  ...
  def to_dict(
    value: Union[
      DashboardInstanceCustomServersDeploymentsListQuery, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
