...
@dataclass
class CustomServersVersionsCreateOutputPush:
  object: str
  id: str
  branch: str
  commit_sha: str
...
class CustomServersVersionsCreateOutput:
  ...
  push: Optional[CustomServersVersionsCreateOutputPush] = None
...
class mapCustomServersVersionsCreateOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> CustomServersVersionsCreateOutput:
    return CustomServersVersionsCreateOutput(
      ...
      push=mapCustomServersVersionsCreateOutputPush.from_dict(data.get("push"))
      if data.get("push")
      else None,
    )
