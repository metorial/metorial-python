...
class mapManagementInstanceCustomServersRemoteServersListOutputItems:
  ...
  def to_dict(
    value: Union[
      ManagementInstanceCustomServersRemoteServersListOutputItems, Dict[str, Any], None
    ]
...
class mapManagementInstanceCustomServersRemoteServersListOutputPagination:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceCustomServersRemoteServersListOutputPagination:
...
class mapManagementInstanceCustomServersRemoteServersListOutput:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceCustomServersRemoteServersListOutput:
    return ManagementInstanceCustomServersRemoteServersListOutput(
      items=[
        mapManagementInstanceCustomServersRemoteServersListOutputItems.from_dict(item)
        for item in data.get("items", [])
        if item
      ],
      pagination=mapManagementInstanceCustomServersRemoteServersListOutputPagination.from_dict(
        data.get("pagination")
      )
  ...
  def to_dict(
    value: Union[
      ManagementInstanceCustomServersRemoteServersListOutput, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
...
class mapManagementInstanceCustomServersRemoteServersListQuery:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceCustomServersRemoteServersListQuery:
  ...
  def to_dict(
    value: Union[
      ManagementInstanceCustomServersRemoteServersListQuery, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
