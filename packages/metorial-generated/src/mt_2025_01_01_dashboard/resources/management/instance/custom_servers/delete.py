...
@dataclass
class ManagementInstanceCustomServersDeleteOutputRepository:
  object: str
  id: str
  name: str
  owner: str
...
class ManagementInstanceCustomServersDeleteOutput:
  ...
  repository: Optional[ManagementInstanceCustomServersDeleteOutputRepository] = None
...
class mapManagementInstanceCustomServersDeleteOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> ManagementInstanceCustomServersDeleteOutput:
    return ManagementInstanceCustomServersDeleteOutput(
      ...
      server=mapManagementInstanceCustomServersDeleteOutputServer.from_dict(
        data.get("server")
      )
      if data.get("server")
      else None,
      server_variant=mapManagementInstanceCustomServersDeleteOutputServerVariant.from_dict(
      ...
      fork=data.get("fork"),
      repository=mapManagementInstanceCustomServersDeleteOutputRepository.from_dict(
        data.get("repository")
      )
  ...
  @staticmethod
  def to_dict(
    value: Union[ManagementInstanceCustomServersDeleteOutput, Dict[str, Any], None]
