...
@dataclass
class ManagementInstanceMagicMcpServersGetOutputDefaultOauthSession:
  object: str
  id: str
  status: str
  metadata: Dict[str, Any]
...
class ManagementInstanceMagicMcpServersGetOutput:
  ...
  default_oauth_session: Optional[
    ManagementInstanceMagicMcpServersGetOutputDefaultOauthSession
  ] = None
...
class mapManagementInstanceMagicMcpServersGetOutput:
  ...
  def from_dict(data: Dict[str, Any]) -> ManagementInstanceMagicMcpServersGetOutput:
    return ManagementInstanceMagicMcpServersGetOutput(
      ...
      default_oauth_session=mapManagementInstanceMagicMcpServersGetOutputDefaultOauthSession.from_dict(
