...
class mapManagementInstanceProviderOauthConnectionsDeleteOutputProvider:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceProviderOauthConnectionsDeleteOutputProvider:
...
class mapManagementInstanceProviderOauthConnectionsDeleteOutput:
  ...
  def from_dict(
    data: Dict[str, Any]
  ) -> ManagementInstanceProviderOauthConnectionsDeleteOutput:
    return ManagementInstanceProviderOauthConnectionsDeleteOutput(
      ...
      provider=mapManagementInstanceProviderOauthConnectionsDeleteOutputProvider.from_dict(
        data.get("provider")
      )
  ...
  def to_dict(
    value: Union[
      ManagementInstanceProviderOauthConnectionsDeleteOutput, Dict[str, Any], None
    ]
  ) -> Optional[Dict[str, Any]]:
    if value is None:
      return None
