...
class MetorialDashboardInstanceCustomServersEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["dashboard", "instances", instance_id, "custom-servers"], query=query_dict
    )
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["dashboard", "instances", instance_id, "custom-servers"], body=body_dict
    )
  ...
  def update(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["dashboard", "instances", instance_id, "custom-servers", custom_server_id],
      body=body_dict,
    )
