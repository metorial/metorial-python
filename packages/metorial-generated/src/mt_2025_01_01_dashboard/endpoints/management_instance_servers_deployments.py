...
class MetorialManagementInstanceServersDeploymentsEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["instances", instance_id, "server-deployments"], query=query_dict
    )
  ...
  def get(
    ...
    """
    request = MetorialRequest(
      path=["instances", instance_id, "server-deployments", server_deployment_id]
    )
    return self._get(request).transform(
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["instances", instance_id, "server-deployments"], body=body_dict
    )
