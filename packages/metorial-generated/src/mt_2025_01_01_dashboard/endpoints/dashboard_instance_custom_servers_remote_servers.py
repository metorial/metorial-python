...
class MetorialDashboardInstanceCustomServersRemoteServersEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    request = MetorialRequest(
      path=["dashboard", "instances", instanceId, "custom-servers", "remote-servers"],
