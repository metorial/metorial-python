...
class MetorialMagicMcpServersEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(path=["magic-mcp-servers"], query=query_dict)
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(path=["magic-mcp-servers"], body=body_dict)
    return self._post(request).transform(
      mapDashboardInstanceMagicMcpServersCreateOutput.from_dict
    )

  def delete(
    self, magic_mcp_server_id: str
  ) -> DashboardInstanceMagicMcpServersDeleteOutput:
    """
  ...
  def update(
    ...
    *,
    ...
    :param default_oauth_session_id: Optional[str] (optional)
    ...
    if default_oauth_session_id is not None:
      body_dict["default_oauth_session_id"] = default_oauth_session_id

    request = MetorialRequest(
      path=["magic-mcp-servers", magic_mcp_server_id], body=body_dict
    )
