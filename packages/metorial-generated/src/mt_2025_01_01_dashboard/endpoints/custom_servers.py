...
class MetorialCustomServersEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(path=["custom-servers"], query=query_dict)
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(path=["custom-servers"], body=body_dict)
  ...
  def delete(self, custom_server_id: str) -> DashboardInstanceCustomServersDeleteOutput:
    """
    ...
    """
    request = MetorialRequest(path=["custom-servers", custom_server_id])
    return self._delete(request).transform(
      mapDashboardInstanceCustomServersDeleteOutput.from_dict
    )

  def get(self, custom_server_id: str) -> DashboardInstanceCustomServersGetOutput:
    """
    Get custom server
