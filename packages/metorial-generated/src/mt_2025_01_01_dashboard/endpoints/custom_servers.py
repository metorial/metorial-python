...
class MetorialCustomServersEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    self, query: DashboardInstanceCustomServersListQuery = None
  ) -> DashboardInstanceCustomServersListOutput:
    """
    List custom servers
  ...
  def create(
    self, body: DashboardInstanceCustomServersCreateBody
  ) -> DashboardInstanceCustomServersCreateOutput:
    """
  ...
  def update(
    self, customServerId: str, body: DashboardInstanceCustomServersUpdateBody
  ) -> DashboardInstanceCustomServersUpdateOutput:
    """
    ...
    """
    request = MetorialRequest(
      path=["custom-servers", customServerId],
  ...
  def delete(self, customServerId: str) -> DashboardInstanceCustomServersDeleteOutput:
    """
    ...
    """
    request = MetorialRequest(path=["custom-servers", customServerId])
    return self._delete(request).transform(
      mapDashboardInstanceCustomServersDeleteOutput.from_dict
    )

  def get(self, customServerId: str) -> DashboardInstanceCustomServersGetOutput:
    """
    Get custom server
