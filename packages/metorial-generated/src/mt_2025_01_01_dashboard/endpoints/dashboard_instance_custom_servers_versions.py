...
class MetorialDashboardInstanceCustomServersVersionsEndpoint(BaseMetorialEndpoint):
  ...
  def get(
    self, instanceId: str, customServerId: str, customServerVersionId: str
  ) -> DashboardInstanceCustomServersVersionsGetOutput:
    """
