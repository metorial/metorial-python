...
class MetorialCustomServersDeploymentsEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    request = MetorialRequest(
      path=["custom-servers", customServerId, "deployments"],
  ...
  def get(
    self, customServerId: str, customServerDeploymentId: str
  ) -> DashboardInstanceCustomServersDeploymentsGetOutput:
    """
    ...
    """
    request = MetorialRequest(
      path=["custom-servers", customServerId, "deployments", customServerDeploymentId]
    )
    return self._get(request).transform(
