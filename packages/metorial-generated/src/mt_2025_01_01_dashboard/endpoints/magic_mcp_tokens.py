...
class MetorialMagicMcpTokensEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    *,
    ...
    request = MetorialRequest(path=["magic-mcp-tokens"], query=query_dict)
  ...
  def get(self, magic_mcp_token_id: str) -> DashboardInstanceMagicMcpTokensGetOutput:
    ...
    """
    request = MetorialRequest(path=["magic-mcp-tokens", magic_mcp_token_id])
    return self._get(request).transform(
  ...
  def create(
    ...
    *,
    ...
    request = MetorialRequest(path=["magic-mcp-tokens"], body=body_dict)
    return self._post(request).transform(
      mapDashboardInstanceMagicMcpTokensCreateOutput.from_dict
    )

  def delete(
    self, magic_mcp_token_id: str
  ) -> DashboardInstanceMagicMcpTokensDeleteOutput:
    """
  ...
  def update(
    ...
    *,
    ...
    request = MetorialRequest(
      path=["magic-mcp-tokens", magic_mcp_token_id], body=body_dict
    )
