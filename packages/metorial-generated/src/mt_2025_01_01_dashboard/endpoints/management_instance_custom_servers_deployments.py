...
class MetorialManagementInstanceCustomServersDeploymentsEndpoint(BaseMetorialEndpoint):
  ...
  def list(
    ...
    request = MetorialRequest(
      path=["instances", instanceId, "custom-servers", customServerId, "deployments"],
